...
namespace Pulumiverse.Scaleway.Autoscaling.Inputs
{
    ...
    public sealed class InstancePolicyMetricGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public InstancePolicyMetricGetArgs()
        {
        }
        public static new InstancePolicyMetricGetArgs Empty => new InstancePolicyMetricGetArgs();
    }
}
