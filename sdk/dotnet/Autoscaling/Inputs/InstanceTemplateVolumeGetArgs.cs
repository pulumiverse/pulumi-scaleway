...
namespace Pulumiverse.Scaleway.Autoscaling.Inputs
{
    ...
    public sealed class InstanceTemplateVolumeGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("fromEmpty")]
        public Input<Inputs.InstanceTemplateVolumeFromEmptyGetArgs>? FromEmpty { get; set; }

        /// <summary>
        /// Volume instance template from snapshot
        /// </summary>
        [Input("fromSnapshot")]
        public Input<Inputs.InstanceTemplateVolumeFromSnapshotGetArgs>? FromSnapshot { get; set; }
        ...
        public InstanceTemplateVolumeGetArgs()
        {
        }
        public static new InstanceTemplateVolumeGetArgs Empty => new InstanceTemplateVolumeGetArgs();
    }
}
