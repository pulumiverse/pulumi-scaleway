...
namespace Pulumiverse.Scaleway
{
    ...
    /// {
    ///     var main = new Scaleway.AutoscalingInstanceTemplate("main", new()
    ///     {
    ///         Name = "asg-template",
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:index/autoscalingInstanceTemplate:AutoscalingInstanceTemplate")]
    public partial class AutoscalingInstanceTemplate : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("volumes")]
        public Output<ImmutableArray<Outputs.AutoscalingInstanceTemplateVolume>> Volumes { get; private set; } = null!;
        ...
        public AutoscalingInstanceTemplate(string name, AutoscalingInstanceTemplateArgs args, CustomResourceOptions? options = null)
            : base("scaleway:index/autoscalingInstanceTemplate:AutoscalingInstanceTemplate", name, args ?? new AutoscalingInstanceTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutoscalingInstanceTemplate(string name, Input<string> id, AutoscalingInstanceTemplateState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:index/autoscalingInstanceTemplate:AutoscalingInstanceTemplate", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AutoscalingInstanceTemplate Get(string name, Input<string> id, AutoscalingInstanceTemplateState? state = null, CustomResourceOptions? options = null)
        {
            return new AutoscalingInstanceTemplate(name, id, state, options);
        }
    }

    public sealed class AutoscalingInstanceTemplateArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The instance image ID. Can be an ID of a marketplace or personal image. This image must be compatible with `volume` and `commercial_type` template.
        /// </summary>
        ...
        [Input("volumes")]
        private InputList<Inputs.AutoscalingInstanceTemplateVolumeArgs>? _volumes;

        /// <summary>
        /// The template of Instance volume.
        /// </summary>
        public InputList<Inputs.AutoscalingInstanceTemplateVolumeArgs> Volumes
        {
            get => _volumes ?? (_volumes = new InputList<Inputs.AutoscalingInstanceTemplateVolumeArgs>());
            set => _volumes = value;
        }
        ...
        public AutoscalingInstanceTemplateArgs()
        {
        }
        public static new AutoscalingInstanceTemplateArgs Empty => new AutoscalingInstanceTemplateArgs();
    }

    public sealed class AutoscalingInstanceTemplateState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The instance image ID. Can be an ID of a marketplace or personal image. This image must be compatible with `volume` and `commercial_type` template.
        /// </summary>
        ...
        [Input("volumes")]
        private InputList<Inputs.AutoscalingInstanceTemplateVolumeGetArgs>? _volumes;

        /// <summary>
        /// The template of Instance volume.
        /// </summary>
        public InputList<Inputs.AutoscalingInstanceTemplateVolumeGetArgs> Volumes
        {
            get => _volumes ?? (_volumes = new InputList<Inputs.AutoscalingInstanceTemplateVolumeGetArgs>());
            set => _volumes = value;
        }
        ...
        public AutoscalingInstanceTemplateState()
        {
        }
        public static new AutoscalingInstanceTemplateState Empty => new AutoscalingInstanceTemplateState();
    }
}
