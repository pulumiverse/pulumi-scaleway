...
namespace Pulumiverse.Scaleway.Containers.Inputs
{
    ...
    public sealed class ContainerLivenessProbeArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("http")]
        public Input<Inputs.ContainerLivenessProbeHttpArgs>? Http { get; set; }
        ...
        public ContainerLivenessProbeArgs()
        {
        }
        public static new ContainerLivenessProbeArgs Empty => new ContainerLivenessProbeArgs();
    }
}
