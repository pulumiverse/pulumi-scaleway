...
namespace Pulumiverse.Scaleway.Databases
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:databases/privilege:Privilege")]
    public partial class Privilege : global::Pulumi.CustomResource
    {
        ...
        public Privilege(string name, PrivilegeArgs args, CustomResourceOptions? options = null)
            : base("scaleway:databases/privilege:Privilege", name, args ?? new PrivilegeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Privilege(string name, Input<string> id, PrivilegeState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:databases/privilege:Privilege", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "scaleway:index/databasePrivilege:DatabasePrivilege" },
                },
            };
