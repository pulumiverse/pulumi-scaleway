...
namespace Pulumiverse.Scaleway.Datawarehouse
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:datawarehouse/deployment:Deployment")]
    public partial class Deployment : global::Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("scaleway:datawarehouse/deployment:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, DeploymentState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:datawarehouse/deployment:Deployment", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DeploymentState : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _publicNetworks ?? (_publicNetworks = new InputList<Inputs.DeploymentPublicNetworkGetArgs>());
