...
namespace Pulumiverse.Scaleway.Domain.Inputs
{
    ...
    public sealed class RegistrationAdministrativeContactArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("extensionEu")]
        public Input<Inputs.RegistrationAdministrativeContactExtensionEuArgs>? ExtensionEu { get; set; }

        /// <summary>
        /// Details specific to French domain extensions.
        /// </summary>
        [Input("extensionFr")]
        public Input<Inputs.RegistrationAdministrativeContactExtensionFrArgs>? ExtensionFr { get; set; }
        ...
        public RegistrationAdministrativeContactArgs()
        {
        }
        public static new RegistrationAdministrativeContactArgs Empty => new RegistrationAdministrativeContactArgs();
    }
}
