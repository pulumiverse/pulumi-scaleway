...
namespace Pulumiverse.Scaleway.Domain.Inputs
{
    ...
    public sealed class RegistrationOwnerContactArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("extensionEu")]
        public Input<Inputs.RegistrationOwnerContactExtensionEuArgs>? ExtensionEu { get; set; }

        /// <summary>
        /// Details specific to French domain extensions.
        /// </summary>
        [Input("extensionFr")]
        public Input<Inputs.RegistrationOwnerContactExtensionFrArgs>? ExtensionFr { get; set; }
        ...
        public RegistrationOwnerContactArgs()
        {
        }
        public static new RegistrationOwnerContactArgs Empty => new RegistrationOwnerContactArgs();
    }
}
