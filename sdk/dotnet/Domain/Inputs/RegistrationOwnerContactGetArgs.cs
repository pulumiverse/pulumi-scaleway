...
namespace Pulumiverse.Scaleway.Domain.Inputs
{
    ...
    public sealed class RegistrationOwnerContactGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("extensionEu")]
        public Input<Inputs.RegistrationOwnerContactExtensionEuGetArgs>? ExtensionEu { get; set; }

        /// <summary>
        /// Details specific to French domain extensions.
        /// </summary>
        [Input("extensionFr")]
        public Input<Inputs.RegistrationOwnerContactExtensionFrGetArgs>? ExtensionFr { get; set; }
        ...
        public RegistrationOwnerContactGetArgs()
        {
        }
        public static new RegistrationOwnerContactGetArgs Empty => new RegistrationOwnerContactGetArgs();
    }
}
