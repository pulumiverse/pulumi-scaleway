...
namespace Pulumiverse.Scaleway.Domain.Outputs
{
    ...
    [OutputType]
    public sealed class GetRegistrationTechnicalContactExtensionEusResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetRegistrationTechnicalContactExtensionEusResult(string europeanCitizenship)
        {
