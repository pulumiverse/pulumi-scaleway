...
namespace Pulumiverse.Scaleway.Domain
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:domain/record:Record")]
    public partial class Record : global::Pulumi.CustomResource
    {
        ...
        public Record(string name, RecordArgs args, CustomResourceOptions? options = null)
            : base("scaleway:domain/record:Record", name, args ?? new RecordArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Record(string name, Input<string> id, RecordState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:domain/record:Record", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "scaleway:index/domainRecord:DomainRecord" },
                },
            };
