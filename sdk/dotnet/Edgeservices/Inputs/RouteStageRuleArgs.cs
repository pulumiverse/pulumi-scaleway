...
namespace Pulumiverse.Scaleway.Edgeservices.Inputs
{
    ...
    public sealed class RouteStageRuleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("ruleHttpMatch")]
        public Input<Inputs.RouteStageRuleRuleHttpMatchArgs>? RuleHttpMatch { get; set; }

        public RouteStageRuleArgs()
        {
        }
        public static new RouteStageRuleArgs Empty => new RouteStageRuleArgs();
    }
}
