...
namespace Pulumiverse.Scaleway.Edgeservices.Inputs
{
    ...
    public sealed class RouteStageRuleGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("ruleHttpMatch")]
        public Input<Inputs.RouteStageRuleRuleHttpMatchGetArgs>? RuleHttpMatch { get; set; }

        public RouteStageRuleGetArgs()
        {
        }
        public static new RouteStageRuleGetArgs Empty => new RouteStageRuleGetArgs();
    }
}
