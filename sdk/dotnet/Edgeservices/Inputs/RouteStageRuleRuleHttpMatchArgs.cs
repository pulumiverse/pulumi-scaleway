...
namespace Pulumiverse.Scaleway.Edgeservices.Inputs
{
    ...
    public sealed class RouteStageRuleRuleHttpMatchArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("hostFilter")]
        public Input<Inputs.RouteStageRuleRuleHttpMatchHostFilterArgs>? HostFilter { get; set; }
        ...
        /// </summary>
        [Input("pathFilter")]
        public Input<Inputs.RouteStageRuleRuleHttpMatchPathFilterArgs>? PathFilter { get; set; }

        public RouteStageRuleRuleHttpMatchArgs()
        {
        }
        public static new RouteStageRuleRuleHttpMatchArgs Empty => new RouteStageRuleRuleHttpMatchArgs();
    }
}
