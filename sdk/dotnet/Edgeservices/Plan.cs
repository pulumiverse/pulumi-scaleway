...
namespace Pulumiverse.Scaleway.Edgeservices
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:edgeservices/plan:Plan")]
    public partial class Plan : global::Pulumi.CustomResource
    {
        ...
        public Plan(string name, PlanArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:edgeservices/plan:Plan", name, args ?? new PlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Plan(string name, Input<string> id, PlanState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:edgeservices/plan:Plan", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "scaleway:index/edgeServicesPlan:EdgeServicesPlan" },
                },
            };
