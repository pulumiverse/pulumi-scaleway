...
namespace Pulumiverse.Scaleway.Edgeservices
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:edgeservices/wafStage:WafStage")]
    public partial class WafStage : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public WafStage(string name, WafStageArgs args, CustomResourceOptions? options = null)
            : base("scaleway:edgeservices/wafStage:WafStage", name, args ?? new WafStageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WafStage(string name, Input<string> id, WafStageState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:edgeservices/wafStage:WafStage", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "scaleway:index/edgeServicesWafStage:EdgeServicesWafStage" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WafStage Get(string name, Input<string> id, WafStageState? state = null, CustomResourceOptions? options = null)
        {
            return new WafStage(name, id, state, options);
        }
    }

    public sealed class WafStageArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The ID of the backend stage to forward requests to after the WAF stage.
        /// </summary>
        ...
        public static new WafStageArgs Empty => new WafStageArgs();
    }

    public sealed class WafStageState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The ID of the backend stage to forward requests to after the WAF stage.
        /// </summary>
        ...
        public WafStageState()
        {
        }
        public static new WafStageState Empty => new WafStageState();
    }
}
