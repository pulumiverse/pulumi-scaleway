...
namespace Pulumiverse.Scaleway.Functions
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:functions/domain:Domain")]
    public partial class Domain : global::Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("scaleway:functions/domain:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, DomainState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:functions/domain:Domain", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "scaleway:index/functionDomain:FunctionDomain" },
                },
            };
