...
namespace Pulumiverse.Scaleway.Functions
{
    public static class GetFunction
    {
        ...
        public static Task<GetFunctionResult> InvokeAsync(GetFunctionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFunctionResult>("scaleway:functions/getFunction:getFunction", args ?? new GetFunctionArgs(), options.WithDefaults());
        ...
        public static Output<GetFunctionResult> Invoke(GetFunctionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFunctionResult>("scaleway:functions/getFunction:getFunction", args ?? new GetFunctionInvokeArgs(), options.WithDefaults());
