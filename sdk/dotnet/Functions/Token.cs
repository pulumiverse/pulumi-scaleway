...
namespace Pulumiverse.Scaleway.Functions
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:functions/token:Token")]
    public partial class Token : global::Pulumi.CustomResource
    {
        ...
        public Token(string name, TokenArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:functions/token:Token", name, args ?? new TokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Token(string name, Input<string> id, TokenState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:functions/token:Token", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "scaleway:index/functionToken:FunctionToken" },
                },
