...
namespace Pulumiverse.Scaleway.Interlink
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:interlink/routingPolicy:RoutingPolicy")]
    public partial class RoutingPolicy : global::Pulumi.CustomResource
    {
        ...
        public RoutingPolicy(string name, RoutingPolicyArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:interlink/routingPolicy:RoutingPolicy", name, args ?? new RoutingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoutingPolicy(string name, Input<string> id, RoutingPolicyState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:interlink/routingPolicy:RoutingPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
