...
namespace Pulumiverse.Scaleway.Kubernetes.Inputs
{
    ...
    public sealed class PoolNodeGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("privateIps")]
        private InputList<Inputs.PoolNodePrivateIpGetArgs>? _privateIps;

        /// <summary>
        /// The list of private IPv4 and IPv6 addresses associated with the node.
        /// </summary>
        public InputList<Inputs.PoolNodePrivateIpGetArgs> PrivateIps
        {
            get => _privateIps ?? (_privateIps = new InputList<Inputs.PoolNodePrivateIpGetArgs>());
