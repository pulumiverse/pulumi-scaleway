...
namespace Pulumiverse.Scaleway.Loadbalancers
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:loadbalancers/frontend:Frontend")]
    public partial class Frontend : global::Pulumi.CustomResource
    {
        ...
        public Frontend(string name, FrontendArgs args, CustomResourceOptions? options = null)
            : base("scaleway:loadbalancers/frontend:Frontend", name, args ?? new FrontendArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Frontend(string name, Input<string> id, FrontendState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:loadbalancers/frontend:Frontend", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "scaleway:index/loadbalancerFrontend:LoadbalancerFrontend" },
                },
            };
