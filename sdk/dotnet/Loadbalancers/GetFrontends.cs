...
namespace Pulumiverse.Scaleway.Loadbalancers
{
    public static class GetFrontends
    {
        ...
        public static Task<GetFrontendsResult> InvokeAsync(GetFrontendsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFrontendsResult>("scaleway:loadbalancers/getFrontends:getFrontends", args ?? new GetFrontendsArgs(), options.WithDefaults());
        ...
        public static Output<GetFrontendsResult> Invoke(GetFrontendsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFrontendsResult>("scaleway:loadbalancers/getFrontends:getFrontends", args ?? new GetFrontendsInvokeArgs(), options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<GetFrontendsResult> Invoke(GetFrontendsInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetFrontendsResult>("scaleway:loadbalancers/getFrontends:getFrontends", args ?? new GetFrontendsInvokeArgs(), options.WithDefaults());
    }
