...
namespace Pulumiverse.Scaleway.Loadbalancers
{
    public static class GetIps
    {
        ...
        public static Task<GetIpsResult> InvokeAsync(GetIpsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIpsResult>("scaleway:loadbalancers/getIps:getIps", args ?? new GetIpsArgs(), options.WithDefaults());
        ...
        public static Output<GetIpsResult> Invoke(GetIpsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIpsResult>("scaleway:loadbalancers/getIps:getIps", args ?? new GetIpsInvokeArgs(), options.WithDefaults());
