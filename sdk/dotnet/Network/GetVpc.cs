...
namespace Pulumiverse.Scaleway.Network
{
    public static class GetVpc
    {
        ...
        public static Task<GetVpcResult> InvokeAsync(GetVpcArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVpcResult>("scaleway:network/getVpc:getVpc", args ?? new GetVpcArgs(), options.WithDefaults());
        ...
        public static Output<GetVpcResult> Invoke(GetVpcInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVpcResult>("scaleway:network/getVpc:getVpc", args ?? new GetVpcInvokeArgs(), options.WithDefaults());
