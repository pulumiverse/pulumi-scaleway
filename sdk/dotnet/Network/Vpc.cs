...
namespace Pulumiverse.Scaleway.Network
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:network/vpc:Vpc")]
    public partial class Vpc : global::Pulumi.CustomResource
    {
        ...
        public Vpc(string name, VpcArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:network/vpc:Vpc", name, args ?? new VpcArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vpc(string name, Input<string> id, VpcState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:network/vpc:Vpc", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "scaleway:index/vpc:Vpc" },
                },
            };
