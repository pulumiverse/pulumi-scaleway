...
namespace Pulumiverse.Scaleway.Object
{
    ...
    public partial class Bucket : global::Pulumi.CustomResource
    {
        ...
        public Bucket(string name, BucketArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:object/bucket:Bucket", name, args ?? new BucketArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Bucket(string name, Input<string> id, BucketState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:object/bucket:Bucket", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "scaleway:index/objectBucket:ObjectBucket" },
                },
            };
