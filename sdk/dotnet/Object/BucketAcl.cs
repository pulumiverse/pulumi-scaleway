...
namespace Pulumiverse.Scaleway.Object
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:object/bucketAcl:BucketAcl")]
    public partial class BucketAcl : global::Pulumi.CustomResource
    {
        ...
        public BucketAcl(string name, BucketAclArgs args, CustomResourceOptions? options = null)
            : base("scaleway:object/bucketAcl:BucketAcl", name, args ?? new BucketAclArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BucketAcl(string name, Input<string> id, BucketAclState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:object/bucketAcl:BucketAcl", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "scaleway:index/objectBucketAcl:ObjectBucketAcl" },
                },
            };
