...
namespace Pulumiverse.Scaleway.Object
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:object/item:Item")]
    public partial class Item : global::Pulumi.CustomResource
    {
        ...
        public Item(string name, ItemArgs args, CustomResourceOptions? options = null)
            : base("scaleway:object/item:Item", name, args ?? new ItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Item(string name, Input<string> id, ItemState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:object/item:Item", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "scaleway:index/objectItem:ObjectItem" },
                },
