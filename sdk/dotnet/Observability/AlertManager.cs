...
namespace Pulumiverse.Scaleway.Observability
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:observability/alertManager:AlertManager")]
    public partial class AlertManager : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.AlertManagerContactPoint>> ContactPoints { get; private set; } = null!;
        ...
        public AlertManager(string name, AlertManagerArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:observability/alertManager:AlertManager", name, args ?? new AlertManagerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertManager(string name, Input<string> id, AlertManagerState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:observability/alertManager:AlertManager", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "scaleway:index/cockpitAlertManager:CockpitAlertManager" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AlertManager Get(string name, Input<string> id, AlertManagerState? state = null, CustomResourceOptions? options = null)
        {
            return new AlertManager(name, id, state, options);
        }
    }

    public sealed class AlertManagerArgs : global::Pulumi.ResourceArgs
    {
        [Input("contactPoints")]
        private InputList<Inputs.AlertManagerContactPointArgs>? _contactPoints;

        /// <summary>
        /// A list of contact points with email addresses that will receive alerts. Each map should contain a single key email.
        /// </summary>
        public InputList<Inputs.AlertManagerContactPointArgs> ContactPoints
        {
            get => _contactPoints ?? (_contactPoints = new InputList<Inputs.AlertManagerContactPointArgs>());
        ...
        public static new AlertManagerArgs Empty => new AlertManagerArgs();
    }

    public sealed class AlertManagerState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The URL of the alert manager.
        /// </summary>
        ...
        [Input("contactPoints")]
        private InputList<Inputs.AlertManagerContactPointGetArgs>? _contactPoints;

        /// <summary>
        /// A list of contact points with email addresses that will receive alerts. Each map should contain a single key email.
        /// </summary>
        public InputList<Inputs.AlertManagerContactPointGetArgs> ContactPoints
        {
            get => _contactPoints ?? (_contactPoints = new InputList<Inputs.AlertManagerContactPointGetArgs>());
            set => _contactPoints = value;
        }
        ...
        public AlertManagerState()
        {
        }
        public static new AlertManagerState Empty => new AlertManagerState();
    }
}
