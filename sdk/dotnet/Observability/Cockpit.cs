...
namespace Pulumiverse.Scaleway.Observability
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:observability/cockpit:Cockpit")]
    public partial class Cockpit : global::Pulumi.CustomResource
    {
        ...
        public Cockpit(string name, CockpitArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:observability/cockpit:Cockpit", name, args ?? new CockpitArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cockpit(string name, Input<string> id, CockpitState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:observability/cockpit:Cockpit", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "scaleway:index/cockpit:Cockpit" },
                },
            };
