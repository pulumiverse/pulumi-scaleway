...
namespace Pulumiverse.Scaleway.Observability
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:observability/source:Source")]
    public partial class Source : global::Pulumi.CustomResource
    {
        ...
        public Source(string name, SourceArgs args, CustomResourceOptions? options = null)
            : base("scaleway:observability/source:Source", name, args ?? new SourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Source(string name, Input<string> id, SourceState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:observability/source:Source", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "scaleway:index/cockpitSource:CockpitSource" },
                },
            };
