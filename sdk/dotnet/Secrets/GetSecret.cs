...
namespace Pulumiverse.Scaleway.Secrets
{
    public static class GetSecret
    {
        ...
        public static Task<GetSecretResult> InvokeAsync(GetSecretArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSecretResult>("scaleway:secrets/getSecret:getSecret", args ?? new GetSecretArgs(), options.WithDefaults());
        ...
        public static Output<GetSecretResult> Invoke(GetSecretInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSecretResult>("scaleway:secrets/getSecret:getSecret", args ?? new GetSecretInvokeArgs(), options.WithDefaults());
