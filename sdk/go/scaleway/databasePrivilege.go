...
// The actual permission currently set in Scaleway. May differ from `permission` after database schema changes (new tables, views, or sequences created).
func (o DatabasePrivilegeOutput) EffectivePermission() pulumi.StringOutput {
	return o.ApplyT(func(v *DatabasePrivilege) pulumi.StringOutput { return v.EffectivePermission }).(pulumi.StringOutput)
}
...
// Permission synchronization status. Possible values:
func (o DatabasePrivilegeOutput) PermissionStatus() pulumi.StringOutput {
	return o.ApplyT(func(v *DatabasePrivilege) pulumi.StringOutput { return v.PermissionStatus }).(pulumi.StringOutput)
}
