...
// `region`) The region
// in which the function was created.
func (o FunctionCronOutput) Region() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FunctionCron) pulumi.StringPtrOutput { return v.Region }).(pulumi.StringPtrOutput)
}
