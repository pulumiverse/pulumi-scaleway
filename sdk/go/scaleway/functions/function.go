...
func NewFunction(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("scaleway:index/function:Function"),
		},
	})
	...
	err := ctx.RegisterResource("scaleway:functions/function:Function", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFunction(ctx *pulumi.Context,
	...
	var resource Function
	err := ctx.ReadResource("scaleway:functions/function:Function", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
