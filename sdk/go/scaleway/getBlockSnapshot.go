...
func (o LookupBlockSnapshotResultOutput) Srn() pulumi.StringOutput {
	return o.ApplyT(func(v LookupBlockSnapshotResult) string { return v.Srn }).(pulumi.StringOutput)
}
