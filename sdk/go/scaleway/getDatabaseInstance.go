...
type LookupDatabaseInstanceResult struct {
	...
	Maintenances       []GetDatabaseInstanceMaintenance       `pulumi:"maintenances"`
	Name               *string                                `pulumi:"name"`
...
func LookupDatabaseInstanceOutput(ctx *pulumi.Context, args LookupDatabaseInstanceOutputArgs, opts ...pulumi.InvokeOption) LookupDatabaseInstanceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDatabaseInstanceResultOutput, error) {
			...
			return ctx.InvokeOutput("scaleway:index/getDatabaseInstance:getDatabaseInstance", args, LookupDatabaseInstanceResultOutput{}, options).(LookupDatabaseInstanceResultOutput), nil
...
func (o LookupDatabaseInstanceResultOutput) Maintenances() GetDatabaseInstanceMaintenanceArrayOutput {
	return o.ApplyT(func(v LookupDatabaseInstanceResult) []GetDatabaseInstanceMaintenance { return v.Maintenances }).(GetDatabaseInstanceMaintenanceArrayOutput)
}
...
func (o LookupDatabaseInstanceResultOutput) PasswordWo() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDatabaseInstanceResult) string { return v.PasswordWo }).(pulumi.StringOutput)
}

func (o LookupDatabaseInstanceResultOutput) PasswordWoVersion() pulumi.IntOutput {
	return o.ApplyT(func(v LookupDatabaseInstanceResult) int { return v.PasswordWoVersion }).(pulumi.IntOutput)
}

func (o LookupDatabaseInstanceResultOutput) PrivateIps() GetDatabaseInstancePrivateIpArrayOutput {
	return o.ApplyT(func(v LookupDatabaseInstanceResult) []GetDatabaseInstancePrivateIp { return v.PrivateIps }).(GetDatabaseInstancePrivateIpArrayOutput)
}
