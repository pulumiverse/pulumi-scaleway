...
func LookupRedisClusterOutput(ctx *pulumi.Context, args LookupRedisClusterOutputArgs, opts ...pulumi.InvokeOption) LookupRedisClusterResultOutput {
	...
	return ctx.InvokeOutput("scaleway:index/getRedisCluster:getRedisCluster", args, LookupRedisClusterResultOutput{}, options).(LookupRedisClusterResultOutput)
}
...
func (o LookupRedisClusterResultOutput) ConnectionString() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRedisClusterResult) string { return v.ConnectionString }).(pulumi.StringOutput)
}
...
func (o LookupRedisClusterResultOutput) PasswordWo() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRedisClusterResult) string { return v.PasswordWo }).(pulumi.StringOutput)
}

func (o LookupRedisClusterResultOutput) PasswordWoVersion() pulumi.IntOutput {
	return o.ApplyT(func(v LookupRedisClusterResult) int { return v.PasswordWoVersion }).(pulumi.IntOutput)
}
