...
func LookupVpcPublicGatewayDhcpReservationOutput(ctx *pulumi.Context, args LookupVpcPublicGatewayDhcpReservationOutputArgs, opts ...pulumi.InvokeOption) LookupVpcPublicGatewayDhcpReservationResultOutput {
	...
	return ctx.InvokeOutput("scaleway:index/getVpcPublicGatewayDhcpReservation:getVpcPublicGatewayDhcpReservation", args, LookupVpcPublicGatewayDhcpReservationResultOutput{}, options).(LookupVpcPublicGatewayDhcpReservationResultOutput)
}
