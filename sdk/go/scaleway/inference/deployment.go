...
type Deployment struct {
	...
	PrivateIps DeploymentPrivateIpArrayOutput `pulumi:"privateIps"`
...
type deploymentState struct {
	...
	// The private IPv4 address associated with the deployment.
	PrivateIps []DeploymentPrivateIp `pulumi:"privateIps"`
	// `projectId`) The ID of the project the deployment is associated with.
...
type DeploymentState struct {
	...
	// The private IPv4 address associated with the deployment.
	PrivateIps DeploymentPrivateIpArrayInput
	// `projectId`) The ID of the project the deployment is associated with.
...
// The private IPv4 address associated with the deployment.
func (o DeploymentOutput) PrivateIps() DeploymentPrivateIpArrayOutput {
	return o.ApplyT(func(v *Deployment) DeploymentPrivateIpArrayOutput { return v.PrivateIps }).(DeploymentPrivateIpArrayOutput)
}
