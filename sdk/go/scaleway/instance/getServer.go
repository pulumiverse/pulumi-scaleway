...
type LookupServerResult struct {
	...
	Filesystems     []GetServerFilesystem `pulumi:"filesystems"`
...
func LookupServerOutput(ctx *pulumi.Context, args LookupServerOutputArgs, opts ...pulumi.InvokeOption) LookupServerResultOutput {
	...
	return ctx.InvokeOutput("scaleway:instance/getServer:getServer", args, LookupServerResultOutput{}, options).(LookupServerResultOutput)
}
...
func (o LookupServerResultOutput) AdminPasswordEncryptionSshKeyId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupServerResult) string { return v.AdminPasswordEncryptionSshKeyId }).(pulumi.StringOutput)
}
...
func (o LookupServerResultOutput) Filesystems() GetServerFilesystemArrayOutput {
	return o.ApplyT(func(v LookupServerResult) []GetServerFilesystem { return v.Filesystems }).(GetServerFilesystemArrayOutput)
}
