...
func (o LookupRouteResultOutput) MatchSubdomains() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupRouteResult) bool { return v.MatchSubdomains }).(pulumi.BoolOutput)
}
