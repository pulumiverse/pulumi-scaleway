...
func LookupPublicGatewayDhcpReservationOutput(ctx *pulumi.Context, args LookupPublicGatewayDhcpReservationOutputArgs, opts ...pulumi.InvokeOption) LookupPublicGatewayDhcpReservationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPublicGatewayDhcpReservationResultOutput, error) {
			args := v.(LookupPublicGatewayDhcpReservationArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("scaleway:network/getPublicGatewayDhcpReservation:getPublicGatewayDhcpReservation", args, LookupPublicGatewayDhcpReservationResultOutput{}, options).(LookupPublicGatewayDhcpReservationResultOutput), nil
