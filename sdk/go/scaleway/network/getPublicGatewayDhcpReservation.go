...
//				Type:            pulumi.String("DEV1-S"),
//				Zone:            pulumi.String("fr-par-1"),
//				SecurityGroupId: mainSecurityGroup.ID().ToIDOutput().ToStringOutput(),
//			})
//			if err != nil {
//				return err
//			}
...
//			}
//			_ = network.LookupPublicGatewayDhcpReservationOutput(ctx, network.GetPublicGatewayDhcpReservationOutputArgs{
//				ReservationId: mainPublicGatewayDhcpReservation.ID().ToIDOutput().ToStringOutput(),
//			}, nil)
//			return nil
//		})
//	}
...
func LookupPublicGatewayDhcpReservation(ctx *pulumi.Context, args *LookupPublicGatewayDhcpReservationArgs, opts ...pulumi.InvokeOption) (*LookupPublicGatewayDhcpReservationResult, error) {
	...
	err := ctx.Invoke("scaleway:network/getPublicGatewayDhcpReservation:getPublicGatewayDhcpReservation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPublicGatewayDhcpReservationOutput(ctx *pulumi.Context, args LookupPublicGatewayDhcpReservationOutputArgs, opts ...pulumi.InvokeOption) LookupPublicGatewayDhcpReservationResultOutput {
	...
	return ctx.InvokeOutput("scaleway:network/getPublicGatewayDhcpReservation:getPublicGatewayDhcpReservation", args, LookupPublicGatewayDhcpReservationResultOutput{}, options).(LookupPublicGatewayDhcpReservationResultOutput)
}
