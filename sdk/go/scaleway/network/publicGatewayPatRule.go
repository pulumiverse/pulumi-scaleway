...
// The Scaleway Resource Name (SRN) of the PAT rule.
func (o PublicGatewayPatRuleOutput) Srn() pulumi.StringOutput {
	return o.ApplyT(func(v *PublicGatewayPatRule) pulumi.StringOutput { return v.Srn }).(pulumi.StringOutput)
}
