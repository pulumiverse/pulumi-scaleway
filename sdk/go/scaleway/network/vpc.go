...
func NewVpc(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("scaleway:index/vpc:Vpc"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Vpc
	err := ctx.RegisterResource("scaleway:network/vpc:Vpc", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpc(ctx *pulumi.Context,
	...
	var resource Vpc
	err := ctx.ReadResource("scaleway:network/vpc:Vpc", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Defines whether the VPC advertises custom routes between its Private Networks. Note that you will not be able to deactivate it afterwards.
func (o VpcOutput) EnableCustomRoutesPropagation() pulumi.BoolOutput {
	return o.ApplyT(func(v *Vpc) pulumi.BoolOutput { return v.EnableCustomRoutesPropagation }).(pulumi.BoolOutput)
}
