...
public final class JobDefinitionArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="cpuLimit", required=true)
     ...
     * 
     */
    @Import(name="memoryLimit", required=true)
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder cpuLimit(Output<Integer> cpuLimit) {
            $.cpuLimit = cpuLimit;
            return this;
        }
         ...
         * 
         */
        public Builder memoryLimit(Output<Integer> memoryLimit) {
        ...
        public JobDefinitionArgs build() {
            $.cpuLimit = Objects.requireNonNull($.cpuLimit, "expected parameter 'cpuLimit' to be non-null");
            $.memoryLimit = Objects.requireNonNull($.memoryLimit, "expected parameter 'memoryLimit' to be non-null");
            return $;
        }
    }
