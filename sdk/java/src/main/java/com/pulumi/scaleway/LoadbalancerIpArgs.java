...
public final class LoadbalancerIpArgs extends com.pulumi.resources.ResourceArgs {

    public static final LoadbalancerIpArgs Empty = new LoadbalancerIpArgs();
    ...
    private LoadbalancerIpArgs() {}

    private LoadbalancerIpArgs(LoadbalancerIpArgs $) {
    ...
    public static Builder builder(LoadbalancerIpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoadbalancerIpArgs();
        }

        public Builder(LoadbalancerIpArgs defaults) {
            $ = new LoadbalancerIpArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LoadbalancerIpArgs build() {
            return $;
        }
    }
