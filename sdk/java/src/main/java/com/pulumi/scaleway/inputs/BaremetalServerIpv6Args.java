...
public final class BaremetalServerIpv6Args extends com.pulumi.resources.ResourceArgs {

    public static final BaremetalServerIpv6Args Empty = new BaremetalServerIpv6Args();
    ...
    private BaremetalServerIpv6Args() {}

    private BaremetalServerIpv6Args(BaremetalServerIpv6Args $) {
    ...
    public static Builder builder(BaremetalServerIpv6Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BaremetalServerIpv6Args();
        }

        public Builder(BaremetalServerIpv6Args defaults) {
            $ = new BaremetalServerIpv6Args(Objects.requireNonNull(defaults));
        }
        ...
        public BaremetalServerIpv6Args build() {
            return $;
        }
    }
