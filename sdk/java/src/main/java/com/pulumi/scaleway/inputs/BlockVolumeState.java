...
public final class BlockVolumeState extends com.pulumi.resources.ResourceArgs {

    public static final BlockVolumeState Empty = new BlockVolumeState();
    ...
    private BlockVolumeState() {}

    private BlockVolumeState(BlockVolumeState $) {
        this.iops = $.iops;
        this.name = $.name;
    ...
    public static Builder builder(BlockVolumeState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BlockVolumeState();
        }

        public Builder(BlockVolumeState defaults) {
            $ = new BlockVolumeState(Objects.requireNonNull(defaults));
        }
