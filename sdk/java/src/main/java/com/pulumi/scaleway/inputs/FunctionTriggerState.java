...
public final class FunctionTriggerState extends com.pulumi.resources.ResourceArgs {

    public static final FunctionTriggerState Empty = new FunctionTriggerState();
    ...
    private FunctionTriggerState() {}

    private FunctionTriggerState(FunctionTriggerState $) {
    ...
    public static Builder builder(FunctionTriggerState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionTriggerState();
        }

        public Builder(FunctionTriggerState defaults) {
            $ = new FunctionTriggerState(Objects.requireNonNull(defaults));
        }
        ...
        public FunctionTriggerState build() {
            return $;
        }
    }
