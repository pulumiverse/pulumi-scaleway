...
public final class MnqSqsCredentialsPermissionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final MnqSqsCredentialsPermissionsArgs Empty = new MnqSqsCredentialsPermissionsArgs();
    ...
    private MnqSqsCredentialsPermissionsArgs() {}

    private MnqSqsCredentialsPermissionsArgs(MnqSqsCredentialsPermissionsArgs $) {
    ...
    public static Builder builder(MnqSqsCredentialsPermissionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MnqSqsCredentialsPermissionsArgs();
        }

        public Builder(MnqSqsCredentialsPermissionsArgs defaults) {
            $ = new MnqSqsCredentialsPermissionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MnqSqsCredentialsPermissionsArgs build() {
            return $;
        }
    }
