...
@CustomType
public final class BaremetalServerIpv4 {
    /**
    ...
    public static Builder builder(BaremetalServerIpv4 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(BaremetalServerIpv4 defaults) {
        ...
        public BaremetalServerIpv4 build() {
            final var o = new BaremetalServerIpv4();
            o.address = address;
            o.id = id;
            o.reverse = reverse;
            o.version = version;
