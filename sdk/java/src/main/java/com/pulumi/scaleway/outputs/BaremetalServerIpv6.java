...
@CustomType
public final class BaremetalServerIpv6 {
    /**
    ...
    public static Builder builder(BaremetalServerIpv6 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(BaremetalServerIpv6 defaults) {
        ...
        public BaremetalServerIpv6 build() {
            final var o = new BaremetalServerIpv6();
            o.address = address;
            o.id = id;
            o.reverse = reverse;
            o.version = version;
