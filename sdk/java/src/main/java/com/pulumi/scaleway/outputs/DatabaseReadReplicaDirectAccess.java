...
@CustomType
public final class DatabaseReadReplicaDirectAccess {
    /**
    ...
    public static Builder builder(DatabaseReadReplicaDirectAccess defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer port;
        public Builder() {}
        public Builder(DatabaseReadReplicaDirectAccess defaults) {
        ...
        public DatabaseReadReplicaDirectAccess build() {
            final var o = new DatabaseReadReplicaDirectAccess();
