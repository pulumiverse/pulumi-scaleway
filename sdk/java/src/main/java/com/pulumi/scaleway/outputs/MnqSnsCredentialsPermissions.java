...
@CustomType
public final class MnqSnsCredentialsPermissions {
    /**
    ...
    public static Builder builder(MnqSnsCredentialsPermissions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean canReceive;
        public Builder() {}
        public Builder(MnqSnsCredentialsPermissions defaults) {
        ...
        public MnqSnsCredentialsPermissions build() {
            final var o = new MnqSnsCredentialsPermissions();
