...
@CustomType
public final class VpcPrivateNetworkIpv6Subnet {
    /**
    ...
    public static Builder builder(VpcPrivateNetworkIpv6Subnet defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedAt;
        public Builder() {}
        public Builder(VpcPrivateNetworkIpv6Subnet defaults) {
        ...
        public VpcPrivateNetworkIpv6Subnet build() {
            final var o = new VpcPrivateNetworkIpv6Subnet();
            o.address = address;
