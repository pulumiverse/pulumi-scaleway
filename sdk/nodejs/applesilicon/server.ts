...
export interface ServerState {
     ...
     * The list of private IPv4 and IPv6 addresses associated with the server.
     */
    privateIps?: pulumi.Input<pulumi.Input<inputs.applesilicon.ServerPrivateIp>[] | undefined>;
    /**
     * The private networks to attach to the server
     */
    privateNetworks?: pulumi.Input<pulumi.Input<inputs.applesilicon.ServerPrivateNetwork>[] | undefined>;
    /**
     * `projectId`) The ID of the project the server is
     * associated with.
     */
