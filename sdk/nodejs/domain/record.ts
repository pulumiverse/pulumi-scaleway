...
export class Record extends pulumi.CustomResource {
     ...
     */
    declare public readonly geoIp: pulumi.Output<outputs.domain.RecordGeoIp | undefined>;
    /**
     * Return record based on client localisation
     */
    declare public readonly httpService: pulumi.Output<outputs.domain.RecordHttpService | undefined>;
    /**
     ...
     */
    declare public readonly views: pulumi.Output<outputs.domain.RecordView[] | undefined>;
    /**
     * Return record based on weight
     */
    declare public readonly weighteds: pulumi.Output<outputs.domain.RecordWeighted[] | undefined>;
