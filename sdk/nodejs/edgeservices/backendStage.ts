 ...
 * ```
 */
export class BackendStage extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BackendStageState, opts?: pulumi.CustomResourceOptions): BackendStage {
        return new BackendStage(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'scaleway:edgeservices/backendStage:BackendStage';

    /**
     * Returns true if the given object is an instance of BackendStage.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is BackendStage {
     ...
     */
    declare public readonly lbBackendConfigs: pulumi.Output<outputs.edgeservices.BackendStageLbBackendConfig[] | undefined>;
    /**
     ...
     */
    declare public readonly s3BackendConfig: pulumi.Output<outputs.edgeservices.BackendStageS3BackendConfig | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: BackendStageArgs | BackendStageState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as BackendStageArgs | undefined;
...
export interface BackendStageState {
     ...
     * The Scaleway Object Storage origin bucket (S3) linked to the backend stage.
     */
    s3BackendConfig?: pulumi.Input<inputs.edgeservices.BackendStageS3BackendConfig | undefined>;
    /**
     * The date and time of the last update of the backend stage.
     */
