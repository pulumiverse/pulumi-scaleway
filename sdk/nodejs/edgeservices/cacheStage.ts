 ...
 * ```
 */
export class CacheStage extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CacheStageState, opts?: pulumi.CustomResourceOptions): CacheStage {
        return new CacheStage(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'scaleway:edgeservices/cacheStage:CacheStage';

    /**
     * Returns true if the given object is an instance of CacheStage.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CacheStage {
     ...
     */
    declare public readonly purgeRequests: pulumi.Output<outputs.edgeservices.CacheStagePurgeRequest[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CacheStageArgs | CacheStageState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CacheStageState | undefined;
            ...
            const args = argsOrState as CacheStageArgs | undefined;
