 ...
 * ```
 */
export function getAuditTrailEvent(args?: GetAuditTrailEventArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditTrailEventResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("scaleway:index/getAuditTrailEvent:getAuditTrailEvent", {
 ...
 */
export interface GetAuditTrailEventArgs {
    /**
 ...
 */
export interface GetAuditTrailEventResult {
    /**
     * List of Audit Trail events matching the requested criteria.
     */
    readonly events: outputs.GetAuditTrailEventEvent[];
    /**
 ...
 * ```
 */
export function getAuditTrailEventOutput(args?: GetAuditTrailEventOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditTrailEventResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scaleway:index/getAuditTrailEvent:getAuditTrailEvent", {
        "methodName": args.methodName,
        "orderBy": args.orderBy,
        "organizationId": args.organizationId,
        "principalId": args.principalId,
 ...
 * A collection of arguments for invoking getAuditTrailEvent.
 */
export interface GetAuditTrailEventOutputArgs {
    /**
     * Name of the method of the API call performed.
     */
