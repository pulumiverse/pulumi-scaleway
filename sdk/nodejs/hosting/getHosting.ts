 ...
 * ```
 */
export function getHosting(args?: GetHostingArgs, opts?: pulumi.InvokeOptions): Promise<GetHostingResult> {
    args = args || {};
 ...
 * ```
 */
export function getHostingOutput(args?: GetHostingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHostingResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
