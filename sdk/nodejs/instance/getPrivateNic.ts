 ...
 * ```
 */
export function getPrivateNicOutput(args: GetPrivateNicOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPrivateNicResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scaleway:instance/getPrivateNic:getPrivateNic", {
        "privateNetworkId": args.privateNetworkId,
        "privateNicId": args.privateNicId,
        "serverId": args.serverId,
        "tags": args.tags,
