 ...
 * ```
 */
export class RoutingPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RoutingPolicyState, opts?: pulumi.CustomResourceOptions): RoutingPolicy {
        return new RoutingPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'scaleway:interlink/routingPolicy:RoutingPolicy';

    /**
     * Returns true if the given object is an instance of RoutingPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RoutingPolicy {
    ...
    constructor(name: string, argsOrState?: RoutingPolicyArgs | RoutingPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RoutingPolicyState | undefined;
            ...
            const args = argsOrState as RoutingPolicyArgs | undefined;
