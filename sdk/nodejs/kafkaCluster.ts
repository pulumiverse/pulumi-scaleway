 ...
 *     vpcId: main.id,
 * });
 * const mainKafkaCluster = new scaleway.KafkaCluster("main", {
...
export class KafkaCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:index/kafkaCluster:KafkaCluster';
     ...
     */
    declare public readonly privateNetwork: pulumi.Output<outputs.KafkaClusterPrivateNetwork | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly publicNetworks: pulumi.Output<outputs.KafkaClusterPublicNetwork[]>;
    /**
...
export interface KafkaClusterState {
     ...
     * Private network endpoint information.
     */
    privateNetwork?: pulumi.Input<inputs.KafkaClusterPrivateNetwork>;
    /**
     * `projectId`) The ID of the project the cluster is associated with.
     */
     ...
     * Public endpoint information.
     */
    publicNetworks?: pulumi.Input<pulumi.Input<inputs.KafkaClusterPublicNetwork>[]>;
    /**
     * `region`) The region in which the cluster should be created.
     */
