...
export interface ClusterState {
     ...
     * The auto upgrade configuration.
     */
    autoUpgrade?: pulumi.Input<inputs.kubernetes.ClusterAutoUpgrade | undefined>;
    /**
     * The configuration options for the [Kubernetes cluster autoscaler](https://github.com/kubernetes/autoscaler/tree/master/cluster-autoscaler).
     */
    autoscalerConfig?: pulumi.Input<inputs.kubernetes.ClusterAutoscalerConfig | undefined>;
    /**
     * The Container Network Interface (CNI) for the Kubernetes cluster.
     * > **Important:** Updates to this field will recreate a new resource.
     */
     ...
     * The kubeconfig configuration file of the Kubernetes cluster
     */
    kubeconfigs?: pulumi.Input<pulumi.Input<inputs.kubernetes.ClusterKubeconfig>[] | undefined>;
    /**
     * The name for the Kubernetes cluster.
     */
     ...
     * The OpenID Connect configuration of the cluster
     */
    openIdConnectConfig?: pulumi.Input<inputs.kubernetes.ClusterOpenIdConnectConfig | undefined>;
    /**
     * The organization ID the cluster is associated with.
     */
