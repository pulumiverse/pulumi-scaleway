...
export interface LoadbalancerState {
     ...
     * The list of private IPv4 and IPv6 addresses associated with the resource.
     */
    privateIps?: pulumi.Input<pulumi.Input<inputs.LoadbalancerPrivateIp>[] | undefined>;
    /**
     * List of private network to connect with your load balancer.
     */
    privateNetworks?: pulumi.Input<pulumi.Input<inputs.LoadbalancerPrivateNetwork>[] | undefined>;
    /**
     * `projectId`) The ID of the Project the Load Balancer is associated with.
     */
