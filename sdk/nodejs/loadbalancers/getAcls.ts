...
export function getAcls(args: GetAclsArgs, opts?: pulumi.InvokeOptions): Promise<GetAclsResult> {
    ...
    return pulumi.runtime.invoke("scaleway:loadbalancers/getAcls:getAcls", {
...
export interface GetAclsResult {
     ...
     */
    readonly acls: outputs.loadbalancers.GetAclsAcl[];
...
export function getAclsOutput(args: GetAclsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAclsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scaleway:loadbalancers/getAcls:getAcls", {
        "frontendId": args.frontendId,
        "name": args.name,
        "projectId": args.projectId,
        "zone": args.zone,
