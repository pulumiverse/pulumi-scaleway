...
export interface GetFrontendsResult {
     ...
     */
    readonly frontends: outputs.loadbalancers.GetFrontendsFrontend[];
    /**
 ...
 * ```
 */
export function getFrontendsOutput(args: GetFrontendsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFrontendsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
