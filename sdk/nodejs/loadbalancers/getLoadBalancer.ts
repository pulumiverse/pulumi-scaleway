...
export function getLoadBalancer(args?: GetLoadBalancerArgs, opts?: pulumi.InvokeOptions): Promise<GetLoadBalancerResult> {
    ...
    return pulumi.runtime.invoke("scaleway:loadbalancers/getLoadBalancer:getLoadBalancer", {
        "lbId": args.lbId,
        "name": args.name,
...
export function getLoadBalancerOutput(args?: GetLoadBalancerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLoadBalancerResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scaleway:loadbalancers/getLoadBalancer:getLoadBalancer", {
        "lbId": args.lbId,
        "name": args.name,
        "projectId": args.projectId,
        "releaseIp": args.releaseIp,
