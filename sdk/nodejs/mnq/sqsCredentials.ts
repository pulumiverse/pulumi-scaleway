...
export class SqsCredentials extends pulumi.CustomResource {
     ...
     */
    declare public readonly permissions: pulumi.Output<outputs.mnq.SqsCredentialsPermissions>;
    /**
...
export interface SqsCredentialsState {
     ...
     * . List of permissions associated with these credentials.
     */
    permissions?: pulumi.Input<inputs.mnq.SqsCredentialsPermissions | undefined>;
    /**
     * `projectId`) The ID of the Project in which SQS is enabled.
     */
