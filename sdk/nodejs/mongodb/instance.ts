...
export class Instance extends pulumi.CustomResource {
     ...
     */
    declare public readonly privateIps: pulumi.Output<outputs.mongodb.InstancePrivateIp[]>;
    /**
     * Private Network endpoints of the Database Instance.
     */
    declare public readonly privateNetwork: pulumi.Output<outputs.mongodb.InstancePrivateNetwork | undefined>;
    /**
     ...
     */
    declare public readonly publicNetwork: pulumi.Output<outputs.mongodb.InstancePublicNetwork>;
    /**
...
export interface InstanceState {
     ...
     * The private IPv4 address associated with the instance.
     */
    privateIps?: pulumi.Input<pulumi.Input<inputs.mongodb.InstancePrivateIp>[] | undefined>;
    /**
     * Private Network endpoints of the Database Instance.
     */
    privateNetwork?: pulumi.Input<inputs.mongodb.InstancePrivateNetwork | undefined>;
    /**
     * `projectId`) The ID of the project the MongoDB® instance is associated with.
     */
     ...
     * Public network endpoint configuration (no arguments).
     */
    publicNetwork?: pulumi.Input<inputs.mongodb.InstancePublicNetwork | undefined>;
    /**
     * `region`) The region in which the MongoDB® instance should be created.
     */
