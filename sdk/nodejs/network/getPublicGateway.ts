...
export function getPublicGateway(args?: GetPublicGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicGatewayResult> {
    ...
    return pulumi.runtime.invoke("scaleway:network/getPublicGateway:getPublicGateway", {
        "name": args.name,
 ...
 * ```
 */
export function getPublicGatewayOutput(args?: GetPublicGatewayOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPublicGatewayResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scaleway:network/getPublicGateway:getPublicGateway", {
        "name": args.name,
        "projectId": args.projectId,
        "publicGatewayId": args.publicGatewayId,
        "zone": args.zone,
