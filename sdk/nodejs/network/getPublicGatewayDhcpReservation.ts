...
export function getPublicGatewayDhcpReservation(args?: GetPublicGatewayDhcpReservationArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicGatewayDhcpReservationResult> {
    ...
    return pulumi.runtime.invoke("scaleway:network/getPublicGatewayDhcpReservation:getPublicGatewayDhcpReservation", {
 ...
 * ```
 */
export function getPublicGatewayDhcpReservationOutput(args?: GetPublicGatewayDhcpReservationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPublicGatewayDhcpReservationResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scaleway:network/getPublicGatewayDhcpReservation:getPublicGatewayDhcpReservation", {
        "gatewayNetworkId": args.gatewayNetworkId,
        "macAddress": args.macAddress,
        "reservationId": args.reservationId,
        "waitForDhcp": args.waitForDhcp,
