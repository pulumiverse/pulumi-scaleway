...
export function getPublicGatewayPatRule(args: GetPublicGatewayPatRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicGatewayPatRuleResult> {
    ...
    return pulumi.runtime.invoke("scaleway:network/getPublicGatewayPatRule:getPublicGatewayPatRule", {
 ...
 * ```
 */
export function getPublicGatewayPatRuleOutput(args: GetPublicGatewayPatRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPublicGatewayPatRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scaleway:network/getPublicGatewayPatRule:getPublicGatewayPatRule", {
        "patRuleId": args.patRuleId,
        "zone": args.zone,
    }, opts);
}
