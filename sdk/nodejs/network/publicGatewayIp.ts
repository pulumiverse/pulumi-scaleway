...
export class PublicGatewayIp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:network/publicGatewayIp:PublicGatewayIp';
    ...
    constructor(name: string, argsOrState?: PublicGatewayIpArgs | PublicGatewayIpState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "scaleway:index/vpcPublicGatewayIp:VpcPublicGatewayIp" }] };
