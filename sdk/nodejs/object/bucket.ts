...
export interface BucketState {
     ...
     * List of CORS rules
     */
    corsRules?: pulumi.Input<pulumi.Input<inputs.object.BucketCorsRule>[] | undefined>;
    /**
     * The endpoint URL of the bucket.
     */
     ...
     * Lifecycle configuration is a set of rules that define actions that Scaleway Object Storage applies to a group of objects
     */
    lifecycleRules?: pulumi.Input<pulumi.Input<inputs.object.BucketLifecycleRule>[] | undefined>;
    /**
     * The name of the bucket.
     */
     ...
     * Allow multiple versions of an object in the same bucket
     */
    versioning?: pulumi.Input<inputs.object.BucketVersioning | undefined>;
}
