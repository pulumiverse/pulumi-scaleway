...
export class ObjectBucket extends pulumi.CustomResource {
     ...
     * List of CORS rules
     */
    declare public readonly corsRules: pulumi.Output<outputs.ObjectBucketCorsRule[]>;
    /**
     ...
     */
    declare public readonly lifecycleRules: pulumi.Output<outputs.ObjectBucketLifecycleRule[] | undefined>;
    /**
     ...
     */
    declare public readonly versioning: pulumi.Output<outputs.ObjectBucketVersioning>;
