...
export class ObjectBucketLockConfiguration extends pulumi.CustomResource {
     ...
     */
    declare public readonly rule: pulumi.Output<outputs.ObjectBucketLockConfigurationRule>;
...
export interface ObjectBucketLockConfigurationState {
     ...
     * Specifies the object lock rule for the specified object.
     */
    rule?: pulumi.Input<inputs.ObjectBucketLockConfigurationRule | undefined>;
}
