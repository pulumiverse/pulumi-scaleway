 ...
 *     },
 * });
 * const gateway = new scaleway.S2sVpnGateway("gateway", {
 *     name: "my-vpn-gateway",
 *     gatewayType: "VGW-S",
 *     privateNetworkId: pn.id,
 * });
 * const customerGw = new scaleway.S2sVpnCustomerGateway("customer_gw", {
 ...
 * });
 * const main = new scaleway.S2sVpnConnection("main", {
 ...
 * ```
 */
export class S2sVpnConnection extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: S2sVpnConnectionState, opts?: pulumi.CustomResourceOptions): S2sVpnConnection {
        return new S2sVpnConnection(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'scaleway:index/s2sVpnConnection:S2sVpnConnection';

    /**
     * Returns true if the given object is an instance of S2sVpnConnection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is S2sVpnConnection {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === S2sVpnConnection.__pulumiType;
    }

    /**
     * BGP configuration for IPv4. See BGP Config below.
     */
    declare public readonly bgpConfigIpv4s: pulumi.Output<outputs.S2sVpnConnectionBgpConfigIpv4[]>;
    /**
     * BGP configuration for IPv6. See BGP Config below.
     */
    declare public readonly bgpConfigIpv6s: pulumi.Output<outputs.S2sVpnConnectionBgpConfigIpv6[]>;
    /**
     * The BGP IPv4 session information. See BGP Session below.
     */
    declare public /*out*/ readonly bgpSessionIpv4s: pulumi.Output<outputs.S2sVpnConnectionBgpSessionIpv4[]>;
    /**
     * The BGP IPv6 session information. See BGP Session below.
     */
    declare public /*out*/ readonly bgpSessionIpv6s: pulumi.Output<outputs.S2sVpnConnectionBgpSessionIpv6[]>;
    /**
     ...
     */
    declare public readonly espCiphers: pulumi.Output<outputs.S2sVpnConnectionEspCipher[]>;
    /**
     * IKEv2 cipher configuration for Phase 1 (tunnel establishment). See Cipher Config below.
     */
    declare public readonly ikev2Ciphers: pulumi.Output<outputs.S2sVpnConnectionIkev2Cipher[]>;
    /**
     ...
     */
    constructor(name: string, args?: S2sVpnConnectionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: S2sVpnConnectionArgs | S2sVpnConnectionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as S2sVpnConnectionState | undefined;
            ...
            const args = argsOrState as S2sVpnConnectionArgs | undefined;
        ...
        super(S2sVpnConnection.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface S2sVpnConnectionState {
    /**
     * BGP configuration for IPv4. See BGP Config below.
     */
    bgpConfigIpv4s?: pulumi.Input<pulumi.Input<inputs.S2sVpnConnectionBgpConfigIpv4>[]>;
    /**
     * BGP configuration for IPv6. See BGP Config below.
     */
    bgpConfigIpv6s?: pulumi.Input<pulumi.Input<inputs.S2sVpnConnectionBgpConfigIpv6>[]>;
    /**
     * The BGP IPv4 session information. See BGP Session below.
     */
    bgpSessionIpv4s?: pulumi.Input<pulumi.Input<inputs.S2sVpnConnectionBgpSessionIpv4>[]>;
    /**
     * The BGP IPv6 session information. See BGP Session below.
     */
    bgpSessionIpv6s?: pulumi.Input<pulumi.Input<inputs.S2sVpnConnectionBgpSessionIpv6>[]>;
    /**
     * The status of the BGP IPv4 session.
     */
     ...
     * ESP cipher configuration for Phase 2 (data encryption). See Cipher Config below.
     */
    espCiphers?: pulumi.Input<pulumi.Input<inputs.S2sVpnConnectionEspCipher>[]>;
    /**
     * IKEv2 cipher configuration for Phase 1 (tunnel establishment). See Cipher Config below.
     */
    ikev2Ciphers?: pulumi.Input<pulumi.Input<inputs.S2sVpnConnectionIkev2Cipher>[]>;
    /**
     * Defines who initiates the IPSec tunnel.
     */
 ...
 */
export interface S2sVpnConnectionArgs {
    /**
     * BGP configuration for IPv4. See BGP Config below.
     */
    bgpConfigIpv4s?: pulumi.Input<pulumi.Input<inputs.S2sVpnConnectionBgpConfigIpv4>[]>;
