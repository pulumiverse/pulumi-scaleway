...
__all__ = ['Scaleway_block_volumeArgs', 'Scaleway_block_volume']

@pulumi.input_type
class Scaleway_block_volumeArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a Scaleway_block_volume resource.
...
@pulumi.input_type
class _Scaleway_block_volumeState:
    def __init__(__self__, *,
                 ...
                 zone: Optional[pulumi.Input[str]] = None):
        """
        Input properties used for looking up and filtering Scaleway_block_volume resources.
        :param pulumi.Input[int] iops: The maximum IO/s expected, must match available options.
        :param pulumi.Input[str] name: The name of the volume. If not provided it will be randomly generated.
        :param pulumi.Input[str] project_id: `project_id`) The ID of the project the volume is associated with.
        :param pulumi.Input[int] size_in_gb: The size of the volume. Only one of `size_in_gb`, and `snapshot_id` should be specified.
...
class Scaleway_block_volume(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        block_volume = scaleway.Scaleway_block_volume("blockVolume",
            iops=5000,
            size_in_gb=20)
        ```
        ...
        ```sh
         $ pulumi import scaleway:index/scaleway_block_volume:scaleway_block_volume block_volume fr-par-1/11111111-1111-1111-1111-111111111111
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Scaleway_block_volumeArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates and manages Scaleway Block Volumes.
        For more information, see [the documentation](https://www.scaleway.com/en/developers/api/block/).
        ...
        :param str resource_name: The name of the resource.
        :param Scaleway_block_volumeArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Scaleway_block_volumeArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = Scaleway_block_volumeArgs.__new__(Scaleway_block_volumeArgs)
        ...
        super(Scaleway_block_volume, __self__).__init__(
            'scaleway:index/scaleway_block_volume:scaleway_block_volume',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            snapshot_id: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            zone: Optional[pulumi.Input[str]] = None) -> 'Scaleway_block_volume':
        """
        Get an existing Scaleway_block_volume resource's state with the given name, id, and optional extra
        ...
        __props__ = _Scaleway_block_volumeState.__new__(_Scaleway_block_volumeState)
        ...
        __props__.__dict__["tags"] = tags
        __props__.__dict__["zone"] = zone
        return Scaleway_block_volume(resource_name, opts=opts, __props__=__props__)
