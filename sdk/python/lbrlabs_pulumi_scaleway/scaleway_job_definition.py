...
__all__ = ['Scaleway_job_definitionArgs', 'Scaleway_job_definition']

@pulumi.input_type
class Scaleway_job_definitionArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a Scaleway_job_definition resource.
...
@pulumi.input_type
class _Scaleway_job_definitionState:
    def __init__(__self__, *,
                 command: Optional[pulumi.Input[str]] = None,
                 ...
                 timeout: Optional[pulumi.Input[str]] = None):
        """
        Input properties used for looking up and filtering Scaleway_job_definition resources.
        :param pulumi.Input[str] command: The command that will be run in the container if specified.
        :param pulumi.Input[int] cpu_limit: The amount of vCPU computing resources to allocate to each container running the job.
        :param pulumi.Input[str] description: The description of the job
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] env: The environment variables of the container.
...
class Scaleway_job_definition(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        main = scaleway.Scaleway_job_definition("main",
            cpu_limit=140,
            memory_limit=256,
        ...
        ```sh
         $ pulumi import scaleway:index/scaleway_job_definition:scaleway_job_definition job fr-par/11111111-1111-1111-1111-111111111111
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Scaleway_job_definitionArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates and manages a Scaleway Serverless Job Definition. For more information, see [the documentation](https://pkg.go.dev/github.com/scaleway/scaleway-sdk-go@master/api/jobs/v1alpha1).
        ...
        :param str resource_name: The name of the resource.
        :param Scaleway_job_definitionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Scaleway_job_definitionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = Scaleway_job_definitionArgs.__new__(Scaleway_job_definitionArgs)
        ...
        super(Scaleway_job_definition, __self__).__init__(
            'scaleway:index/scaleway_job_definition:scaleway_job_definition',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[str]] = None,
            region: Optional[pulumi.Input[str]] = None,
            timeout: Optional[pulumi.Input[str]] = None) -> 'Scaleway_job_definition':
        """
        Get an existing Scaleway_job_definition resource's state with the given name, id, and optional extra
        ...
        __props__ = _Scaleway_job_definitionState.__new__(_Scaleway_job_definitionState)
        ...
        __props__.__dict__["region"] = region
        __props__.__dict__["timeout"] = timeout
        return Scaleway_job_definition(resource_name, opts=opts, __props__=__props__)
