...
__all__ = ['Scaleway_mnq_sns_topicArgs', 'Scaleway_mnq_sns_topic']

@pulumi.input_type
class Scaleway_mnq_sns_topicArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a Scaleway_mnq_sns_topic resource.
...
@pulumi.input_type
class _Scaleway_mnq_sns_topicState:
    def __init__(__self__, *,
                 ...
                 sns_endpoint: Optional[pulumi.Input[str]] = None):
        """
        Input properties used for looking up and filtering Scaleway_mnq_sns_topic resources.
        :param pulumi.Input[str] access_key: The access key of the SNS credentials.
...
class Scaleway_mnq_sns_topic(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        ```sh
         $ pulumi import scaleway:index/scaleway_mnq_sns_topic:scaleway_mnq_sns_topic main fr-par/11111111111111111111111111111111/my-topic
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Scaleway_mnq_sns_topicArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manage Scaleway Messaging and queuing SNS Topics.
        For further information please check
        ...
        :param str resource_name: The name of the resource.
        :param Scaleway_mnq_sns_topicArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Scaleway_mnq_sns_topicArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = Scaleway_mnq_sns_topicArgs.__new__(Scaleway_mnq_sns_topicArgs)
        ...
        super(Scaleway_mnq_sns_topic, __self__).__init__(
            'scaleway:index/scaleway_mnq_sns_topic:scaleway_mnq_sns_topic',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[str]] = None,
            secret_key: Optional[pulumi.Input[str]] = None,
            sns_endpoint: Optional[pulumi.Input[str]] = None) -> 'Scaleway_mnq_sns_topic':
        """
        Get an existing Scaleway_mnq_sns_topic resource's state with the given name, id, and optional extra
        ...
        __props__ = _Scaleway_mnq_sns_topicState.__new__(_Scaleway_mnq_sns_topicState)
        ...
        __props__.__dict__["sns_endpoint"] = sns_endpoint
        return Scaleway_mnq_sns_topic(resource_name, opts=opts, __props__=__props__)
