...
__all__ = ['Scaleway_mnq_sns_topic_subscriptionArgs', 'Scaleway_mnq_sns_topic_subscription']

@pulumi.input_type
class Scaleway_mnq_sns_topic_subscriptionArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a Scaleway_mnq_sns_topic_subscription resource.
...
@pulumi.input_type
class _Scaleway_mnq_sns_topic_subscriptionState:
    def __init__(__self__, *,
                 ...
                 topic_id: Optional[pulumi.Input[str]] = None):
        """
        Input properties used for looking up and filtering Scaleway_mnq_sns_topic_subscription resources.
        :param pulumi.Input[str] access_key: The access key of the SNS credentials.
...
class Scaleway_mnq_sns_topic_subscription(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        topic = scaleway.Scaleway_mnq_sns_topic("topic",
            project_id=mainscaleway_mnq_sns.project_id,
            access_key=mainscaleway_mnq_sns_credentials.access_key,
            secret_key=mainscaleway_mnq_sns_credentials.secret_key)
        mainscaleway_mnq_sns_topic_subscription = scaleway.Scaleway_mnq_sns_topic_subscription("mainscaleway_mnq_sns_topic_subscription",
            project_id=mainscaleway_mnq_sns.project_id,
            access_key=mainscaleway_mnq_sns_credentials.access_key,
            secret_key=mainscaleway_mnq_sns_credentials.secret_key,
            topic_id=topic.id,
        ...
        ```sh
         $ pulumi import scaleway:index/scaleway_mnq_sns_topic_subscription:scaleway_mnq_sns_topic_subscription main fr-par/11111111111111111111111111111111/my-topic/11111111111111111111111111111111
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Scaleway_mnq_sns_topic_subscriptionArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manage Scaleway Messaging and queuing SNS Topic Subscriptions.
        For further information please check
        ...
        :param str resource_name: The name of the resource.
        :param Scaleway_mnq_sns_topic_subscriptionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Scaleway_mnq_sns_topic_subscriptionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = Scaleway_mnq_sns_topic_subscriptionArgs.__new__(Scaleway_mnq_sns_topic_subscriptionArgs)
        ...
        super(Scaleway_mnq_sns_topic_subscription, __self__).__init__(
            'scaleway:index/scaleway_mnq_sns_topic_subscription:scaleway_mnq_sns_topic_subscription',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            sns_endpoint: Optional[pulumi.Input[str]] = None,
            topic_arn: Optional[pulumi.Input[str]] = None,
            topic_id: Optional[pulumi.Input[str]] = None) -> 'Scaleway_mnq_sns_topic_subscription':
        """
        Get an existing Scaleway_mnq_sns_topic_subscription resource's state with the given name, id, and optional extra
        ...
        __props__ = _Scaleway_mnq_sns_topic_subscriptionState.__new__(_Scaleway_mnq_sns_topic_subscriptionState)
        ...
        __props__.__dict__["topic_arn"] = topic_arn
        __props__.__dict__["topic_id"] = topic_id
        return Scaleway_mnq_sns_topic_subscription(resource_name, opts=opts, __props__=__props__)
