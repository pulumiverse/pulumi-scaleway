...
__all__ = [
    'GetRegistryNamespaceBetaResult',
    'AwaitableGetRegistryNamespaceBetaResult',
    'get_registry_namespace_beta',
]
...
def get_registry_namespace_beta(name: Optional[str] = None,
                                namespace_id: Optional[str] = None,
                                region: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRegistryNamespaceBetaResult:
    """
    ...
    my_namespace = scaleway.get_registry_namespace_beta(namespace_id="11111111-1111-1111-1111-111111111111")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:index/getRegistryNamespaceBeta:getRegistryNamespaceBeta', __args__, opts=opts, typ=GetRegistryNamespaceBetaResult).value
