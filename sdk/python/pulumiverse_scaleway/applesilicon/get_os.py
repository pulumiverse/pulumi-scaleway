...
def get_os(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:applesilicon/getOs:getOs', __args__, opts=opts, typ=GetOsResult).value
...
def get_os_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:applesilicon/getOs:getOs', __args__, opts=opts, typ=GetOsResult)
