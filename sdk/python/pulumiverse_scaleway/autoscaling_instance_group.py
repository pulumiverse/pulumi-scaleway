...
__all__ = ['AutoscalingInstanceGroupArgs', 'AutoscalingInstanceGroup']

@pulumi.input_type
class AutoscalingInstanceGroupArgs:
    def __init__(__self__, *,
                 template_id: pulumi.Input[builtins.str],
                 capacities: Optional[pulumi.Input[Sequence[pulumi.Input['AutoscalingInstanceGroupCapacityArgs']]]] = None,
                 delete_servers_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 load_balancers: Optional[pulumi.Input[Sequence[pulumi.Input['AutoscalingInstanceGroupLoadBalancerArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AutoscalingInstanceGroupCapacityArgs']]] capacities: The specification of the minimum and maximum replicas for the Instance group, and the cooldown interval between two scaling events.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AutoscalingInstanceGroupLoadBalancerArgs']]] load_balancers: The specification of the Load Balancer to link to the Instance group.
    ...
    @property
    @pulumi.getter
    def capacities(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['AutoscalingInstanceGroupCapacityArgs']]]]:
        """
    ...
    @capacities.setter
    def capacities(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['AutoscalingInstanceGroupCapacityArgs']]]]):
    ...
    def load_balancers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['AutoscalingInstanceGroupLoadBalancerArgs']]]]:
        """
    ...
    def load_balancers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['AutoscalingInstanceGroupLoadBalancerArgs']]]]):
...
@pulumi.input_type
class _AutoscalingInstanceGroupState:
    def __init__(__self__, *,
                 capacities: Optional[pulumi.Input[Sequence[pulumi.Input['AutoscalingInstanceGroupCapacityArgs']]]] = None,
...
@pulumi.type_token("scaleway:index/autoscalingInstanceGroup:AutoscalingInstanceGroup")
class AutoscalingInstanceGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 capacities: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AutoscalingInstanceGroupCapacityArgs', 'AutoscalingInstanceGroupCapacityArgsDict']]]]] = None,
                 delete_servers_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 load_balancers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AutoscalingInstanceGroupLoadBalancerArgs', 'AutoscalingInstanceGroupLoadBalancerArgsDict']]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 template_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        main = scaleway.AutoscalingInstanceGroup("main",
            name="asg-group",
        ...
        main_backend = scaleway.loadbalancers.Backend("main",
            ...
            forward_port=80,
            proxy_protocol="none")
        main_autoscaling_instance_template = scaleway.AutoscalingInstanceTemplate("main",
        ...
        main_autoscaling_instance_group = scaleway.AutoscalingInstanceGroup("main",
            name="autoscaling-instance-group-basic",
            template_id=main_autoscaling_instance_template.id,
            tags=[
                "terraform-test",
                "instance-group",
            ],
        ...
        up = scaleway.AutoscalingInstancePolicy("up",
            instance_group_id=main_autoscaling_instance_group.id,
        ...
        down = scaleway.AutoscalingInstancePolicy("down",
            instance_group_id=main_autoscaling_instance_group.id,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['AutoscalingInstanceGroupCapacityArgs', 'AutoscalingInstanceGroupCapacityArgsDict']]]] capacities: The specification of the minimum and maximum replicas for the Instance group, and the cooldown interval between two scaling events.
        :param pulumi.Input[builtins.bool] delete_servers_on_destroy: Whether to delete all instances in this group when the group is destroyed. Set to `true` to tear them down, `false` (the default) leaves them running.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AutoscalingInstanceGroupLoadBalancerArgs', 'AutoscalingInstanceGroupLoadBalancerArgsDict']]]] load_balancers: The specification of the Load Balancer to link to the Instance group.
        :param pulumi.Input[builtins.str] name: The Instance group name.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the Project the Instance group is associated with.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags associated with the Instance group.
        :param pulumi.Input[builtins.str] template_id: The ID of the Instance template to attach to the Instance group.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AutoscalingInstanceGroupArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Books and manages Autoscaling Instance groups.
        ...
        :param str resource_name: The name of the resource.
        :param AutoscalingInstanceGroupArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AutoscalingInstanceGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AutoscalingInstanceGroupArgs.__new__(AutoscalingInstanceGroupArgs)
        ...
        super(AutoscalingInstanceGroup, __self__).__init__(
            'scaleway:index/autoscalingInstanceGroup:AutoscalingInstanceGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            template_id: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'AutoscalingInstanceGroup':
        """
        ...
        __props__ = _AutoscalingInstanceGroupState.__new__(_AutoscalingInstanceGroupState)
        ...
        __props__.__dict__["zone"] = zone
        return AutoscalingInstanceGroup(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def capacities(self) -> pulumi.Output[Sequence['outputs.AutoscalingInstanceGroupCapacity']]:
        """
        The specification of the minimum and maximum replicas for the Instance group, and the cooldown interval between two scaling events.
        """
        return pulumi.get(self, "capacities")
    ...
    @property
    @pulumi.getter(name="loadBalancers")
    def load_balancers(self) -> pulumi.Output[Sequence['outputs.AutoscalingInstanceGroupLoadBalancer']]:
        """
        The specification of the Load Balancer to link to the Instance group.
        """
        return pulumi.get(self, "load_balancers")
