...
__all__ = ['AutoscalingInstancePolicyArgs', 'AutoscalingInstancePolicy']

@pulumi.input_type
class AutoscalingInstancePolicyArgs:
    def __init__(__self__, *,
                 ...
                 metrics: Optional[pulumi.Input[Sequence[pulumi.Input['AutoscalingInstancePolicyMetricArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AutoscalingInstancePolicyMetricArgs']]] metrics: Cockpit metric to use when determining whether to trigger a scale up/down action.
    ...
    @property
    @pulumi.getter
    def metrics(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['AutoscalingInstancePolicyMetricArgs']]]]:
        """
    ...
    @metrics.setter
    def metrics(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['AutoscalingInstancePolicyMetricArgs']]]]):
...
@pulumi.input_type
class _AutoscalingInstancePolicyState:
    def __init__(__self__, *,
...
@pulumi.type_token("scaleway:index/autoscalingInstancePolicy:AutoscalingInstancePolicy")
class AutoscalingInstancePolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 action: Optional[pulumi.Input[builtins.str]] = None,
                 instance_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 metrics: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AutoscalingInstancePolicyMetricArgs', 'AutoscalingInstancePolicyMetricArgsDict']]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 priority: Optional[pulumi.Input[builtins.int]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] action: The action to execute when the metric-based condition is met.
        :param pulumi.Input[builtins.str] instance_group_id: The ID of the Instance group related to this policy.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AutoscalingInstancePolicyMetricArgs', 'AutoscalingInstancePolicyMetricArgsDict']]]] metrics: Cockpit metric to use when determining whether to trigger a scale up/down action.
        :param pulumi.Input[builtins.str] name: The Instance policy name.
        :param pulumi.Input[builtins.int] priority: The priority of this policy compared to all other scaling policies. This determines the processing order. The lower the number, the higher the priority.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the Project the Instance policy is associated with.
        :param pulumi.Input[builtins.str] type: How to use the number defined in `value` when determining by how many Instances to scale up/down.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AutoscalingInstancePolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Books and manages Autoscaling Instance policies.
        ...
        :param str resource_name: The name of the resource.
        :param AutoscalingInstancePolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AutoscalingInstancePolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AutoscalingInstancePolicyArgs.__new__(AutoscalingInstancePolicyArgs)
        ...
        super(AutoscalingInstancePolicy, __self__).__init__(
            'scaleway:index/autoscalingInstancePolicy:AutoscalingInstancePolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.int]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'AutoscalingInstancePolicy':
        """
        ...
        __props__ = _AutoscalingInstancePolicyState.__new__(_AutoscalingInstancePolicyState)
        ...
        __props__.__dict__["value"] = value
        __props__.__dict__["zone"] = zone
        return AutoscalingInstancePolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def metrics(self) -> pulumi.Output[Sequence['outputs.AutoscalingInstancePolicyMetric']]:
        """
        Cockpit metric to use when determining whether to trigger a scale up/down action.
        """
        return pulumi.get(self, "metrics")
