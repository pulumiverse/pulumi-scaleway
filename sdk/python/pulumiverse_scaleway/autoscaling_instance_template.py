...
__all__ = ['AutoscalingInstanceTemplateArgs', 'AutoscalingInstanceTemplate']

@pulumi.input_type
class AutoscalingInstanceTemplateArgs:
    def __init__(__self__, *,
                 ...
                 volumes: Optional[pulumi.Input[Sequence[pulumi.Input['AutoscalingInstanceTemplateVolumeArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AutoscalingInstanceTemplateVolumeArgs']]] volumes: The template of Instance volume.
    ...
    @property
    @pulumi.getter
    def volumes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['AutoscalingInstanceTemplateVolumeArgs']]]]:
        """
    ...
    @volumes.setter
    def volumes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['AutoscalingInstanceTemplateVolumeArgs']]]]):
...
@pulumi.input_type
class _AutoscalingInstanceTemplateState:
    def __init__(__self__, *,
                 cloud_init: Optional[pulumi.Input[builtins.str]] = None,
...
@pulumi.type_token("scaleway:index/autoscalingInstanceTemplate:AutoscalingInstanceTemplate")
class AutoscalingInstanceTemplate(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 security_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 volumes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AutoscalingInstanceTemplateVolumeArgs', 'AutoscalingInstanceTemplateVolumeArgsDict']]]]] = None,
                 zone: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
        ...
        main = scaleway.AutoscalingInstanceTemplate("main",
            name="asg-template",
        ...
        :param pulumi.Input[builtins.str] security_group_id: The instance security group ID.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags associated with the Instance template.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AutoscalingInstanceTemplateVolumeArgs', 'AutoscalingInstanceTemplateVolumeArgsDict']]]] volumes: The template of Instance volume.
        :param pulumi.Input[builtins.str] zone: `zone`) The zone in which the Instance template exists.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: AutoscalingInstanceTemplateArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Books and manages Autoscaling Instance templates.
        ...
        :param str resource_name: The name of the resource.
        :param AutoscalingInstanceTemplateArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AutoscalingInstanceTemplateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AutoscalingInstanceTemplateArgs.__new__(AutoscalingInstanceTemplateArgs)
        ...
        super(AutoscalingInstanceTemplate, __self__).__init__(
            'scaleway:index/autoscalingInstanceTemplate:AutoscalingInstanceTemplate',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            volumes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AutoscalingInstanceTemplateVolumeArgs', 'AutoscalingInstanceTemplateVolumeArgsDict']]]]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'AutoscalingInstanceTemplate':
        """
        ...
        __props__ = _AutoscalingInstanceTemplateState.__new__(_AutoscalingInstanceTemplateState)
        ...
        __props__.__dict__["volumes"] = volumes
        __props__.__dict__["zone"] = zone
        return AutoscalingInstanceTemplate(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def volumes(self) -> pulumi.Output[Optional[Sequence['outputs.AutoscalingInstanceTemplateVolume']]]:
        """
        The template of Instance volume.
        """
        return pulumi.get(self, "volumes")
