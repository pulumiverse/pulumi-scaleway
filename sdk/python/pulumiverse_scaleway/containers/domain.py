...
@pulumi.type_token("scaleway:containers/domain:Domain")
class Domain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="scaleway:index/containerDomain:ContainerDomain")])
