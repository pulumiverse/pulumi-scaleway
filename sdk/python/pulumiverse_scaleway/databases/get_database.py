...
def get_database(instance_id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:databases/getDatabase:getDatabase', __args__, opts=opts, typ=GetDatabaseResult).value
...
def get_database_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:databases/getDatabase:getDatabase', __args__, opts=opts, typ=GetDatabaseResult)
