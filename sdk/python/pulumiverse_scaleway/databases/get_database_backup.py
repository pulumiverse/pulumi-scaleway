...
def get_database_backup(backup_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str project_id: The ID of the project the Database Backup is associated with.
    :param _builtins.str region: `region`) The region in which the Database Backup is associated with.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:databases/getDatabaseBackup:getDatabaseBackup', __args__, opts=opts, typ=GetDatabaseBackupResult).value
...
def get_database_backup_output(backup_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:databases/getDatabaseBackup:getDatabaseBackup', __args__, opts=opts, typ=GetDatabaseBackupResult)
