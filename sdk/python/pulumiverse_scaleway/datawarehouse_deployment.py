...
__all__ = ['DatawarehouseDeploymentArgs', 'DatawarehouseDeployment']

@pulumi.input_type
class DatawarehouseDeploymentArgs:
...
@pulumi.input_type
class _DatawarehouseDeploymentState:
    def __init__(__self__, *,
                 ...
                 password: Optional[pulumi.Input[_builtins.str]] = None,
                 project_id: Optional[pulumi.Input[_builtins.str]] = None,
                 public_networks: Optional[pulumi.Input[Sequence[pulumi.Input['DatawarehouseDeploymentPublicNetworkArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] project_id: `project_id`) The ID of the project the deployment is associated with.
               ...
               > **Note:** During the private beta phase, modifying `cpu_min`, `cpu_max`, and `replica_count` has no effect until the feature is launched in general availability.
        :param pulumi.Input[Sequence[pulumi.Input['DatawarehouseDeploymentPublicNetworkArgs']]] public_networks: Public endpoint information (always created automatically).
        :param pulumi.Input[_builtins.int] ram_per_cpu: RAM per CPU in GB.
        :param pulumi.Input[_builtins.str] region: `region`) The region in which the deployment should be created.
        :param pulumi.Input[_builtins.int] replica_count: Number of replicas.
    ...
    def public_networks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DatawarehouseDeploymentPublicNetworkArgs']]]]:
        """
    ...
    def public_networks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DatawarehouseDeploymentPublicNetworkArgs']]]]):
...
@pulumi.type_token("scaleway:index/datawarehouseDeployment:DatawarehouseDeployment")
class DatawarehouseDeployment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        main = scaleway.DatawarehouseDeployment("main",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatawarehouseDeploymentArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates and manages Scaleway Data Warehouse deployments.
        For more information refer to the [product documentation](https://www.scaleway.com/en/docs/data-warehouse/).
        ...
        :param str resource_name: The name of the resource.
        :param DatawarehouseDeploymentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatawarehouseDeploymentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatawarehouseDeploymentArgs.__new__(DatawarehouseDeploymentArgs)
        ...
        super(DatawarehouseDeployment, __self__).__init__(
            'scaleway:index/datawarehouseDeployment:DatawarehouseDeployment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[_builtins.str]] = None,
            project_id: Optional[pulumi.Input[_builtins.str]] = None,
            public_networks: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DatawarehouseDeploymentPublicNetworkArgs', 'DatawarehouseDeploymentPublicNetworkArgsDict']]]]] = None,
            ram_per_cpu: Optional[pulumi.Input[_builtins.int]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            replica_count: Optional[pulumi.Input[_builtins.int]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            version: Optional[pulumi.Input[_builtins.str]] = None) -> 'DatawarehouseDeployment':
        """
        ...
        :param pulumi.Input[_builtins.str] project_id: `project_id`) The ID of the project the deployment is associated with.
               ...
               > **Note:** During the private beta phase, modifying `cpu_min`, `cpu_max`, and `replica_count` has no effect until the feature is launched in general availability.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DatawarehouseDeploymentPublicNetworkArgs', 'DatawarehouseDeploymentPublicNetworkArgsDict']]]] public_networks: Public endpoint information (always created automatically).
        :param pulumi.Input[_builtins.int] ram_per_cpu: RAM per CPU in GB.
        :param pulumi.Input[_builtins.str] region: `region`) The region in which the deployment should be created.
        :param pulumi.Input[_builtins.int] replica_count: Number of replicas.
        :param pulumi.Input[_builtins.str] status: The status of the deployment (e.g., "ready", "provisioning").
        ...
        __props__ = _DatawarehouseDeploymentState.__new__(_DatawarehouseDeploymentState)
        ...
        __props__.__dict__["version"] = version
        return DatawarehouseDeployment(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="publicNetworks")
    def public_networks(self) -> pulumi.Output[Sequence['outputs.DatawarehouseDeploymentPublicNetwork']]:
        """
        Public endpoint information (always created automatically).
        """
        return pulumi.get(self, "public_networks")
