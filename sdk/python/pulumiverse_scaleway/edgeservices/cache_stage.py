...
__all__ = ['CacheStageArgs', 'CacheStage']

@pulumi.input_type
class CacheStageArgs:
    def __init__(__self__, *,
                 ...
                 purge_requests: Optional[pulumi.Input[Sequence[pulumi.Input['CacheStagePurgeRequestArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CacheStagePurgeRequestArgs']]] purge_requests: The Scaleway Object Storage origin bucket (S3) linked to the backend stage.
    ...
    def purge_requests(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CacheStagePurgeRequestArgs']]]]:
        """
    ...
    def purge_requests(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CacheStagePurgeRequestArgs']]]]):
...
@pulumi.type_token("scaleway:edgeservices/cacheStage:CacheStage")
class CacheStage(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 pipeline_id: Optional[pulumi.Input[_builtins.str]] = None,
                 project_id: Optional[pulumi.Input[_builtins.str]] = None,
                 purge_requests: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CacheStagePurgeRequestArgs', 'CacheStagePurgeRequestArgsDict']]]]] = None,
                 refresh_cache: Optional[pulumi.Input[_builtins.str]] = None,
                 route_stage_id: Optional[pulumi.Input[_builtins.str]] = None,
                 waf_stage_id: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[_builtins.str] pipeline_id: The ID of the pipeline.
        :param pulumi.Input[_builtins.str] project_id: `project_id`) The ID of the project the cache stage is associated with.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CacheStagePurgeRequestArgs', 'CacheStagePurgeRequestArgsDict']]]] purge_requests: The Scaleway Object Storage origin bucket (S3) linked to the backend stage.
        :param pulumi.Input[_builtins.str] refresh_cache: Trigger a refresh of the cache by changing this field's value.
        :param pulumi.Input[_builtins.str] route_stage_id: The route stage ID the cache stage will be linked to. Only one of `backend_stage_id`, `route_stage_id` and `waf_stage_id` should be specified.
        :param pulumi.Input[_builtins.str] waf_stage_id: The WAF stage ID the cache stage will be linked to. Only one of `backend_stage_id`, `route_stage_id` and `waf_stage_id` should be specified.
        """
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CacheStageArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CacheStageArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CacheStageArgs.__new__(CacheStageArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="scaleway:index/edgeServicesCacheStage:EdgeServicesCacheStage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CacheStage, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            route_stage_id: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            waf_stage_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'CacheStage':
        """
        ...
        __props__ = _CacheStageState.__new__(_CacheStageState)
        ...
        __props__.__dict__["waf_stage_id"] = waf_stage_id
        return CacheStage(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="purgeRequests")
    def purge_requests(self) -> pulumi.Output[Optional[Sequence['outputs.CacheStagePurgeRequest']]]:
        """
        The Scaleway Object Storage origin bucket (S3) linked to the backend stage.
        """
        return pulumi.get(self, "purge_requests")
