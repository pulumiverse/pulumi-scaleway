...
@pulumi.type_token("scaleway:edgeservices/dnsStage:DnsStage")
class DnsStage(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DnsStageArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DnsStageArgs.__new__(DnsStageArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="scaleway:index/edgeServicesDnsStage:EdgeServicesDnsStage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DnsStage, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            type: pulumi.Input[Optional[_builtins.str]] = None,
            updated_at: pulumi.Input[Optional[_builtins.str]] = None,
            wildcard_domain: pulumi.Input[Optional[_builtins.bool]] = None) -> 'DnsStage':
        """
        ...
        __props__ = _DnsStageState.__new__(_DnsStageState)
        ...
        __props__.__dict__["wildcard_domain"] = wildcard_domain
        return DnsStage(resource_name, opts=opts, __props__=__props__)
