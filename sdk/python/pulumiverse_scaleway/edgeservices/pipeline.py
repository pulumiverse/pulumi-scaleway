...
@pulumi.type_token("scaleway:edgeservices/pipeline:Pipeline")
class Pipeline(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="scaleway:index/edgeServicesPipeline:EdgeServicesPipeline")])
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'Pipeline':
        """
