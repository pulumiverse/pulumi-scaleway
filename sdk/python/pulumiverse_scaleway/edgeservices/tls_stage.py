...
class TlsStageArgs:
    def __init__(__self__, *,
                 ...
                 managed_certificate: pulumi.Input[Optional[_builtins.bool]] = None,
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 route_stage_id: pulumi.Input[Optional[_builtins.str]] = None,
                 secrets: pulumi.Input[Optional[Sequence[pulumi.Input['TlsStageSecretArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['TlsStageSecretArgs']]] secrets: The TLS secrets.
    ...
    def managed_certificate(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def managed_certificate(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    @_builtins.property
    @pulumi.getter
    def secrets(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['TlsStageSecretArgs']]]]:
        """
        The TLS secrets.
        """
    ...
    @secrets.setter
    def secrets(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['TlsStageSecretArgs']]]]):
...
@pulumi.input_type
class _TlsStageState:
    def __init__(__self__, *,
                 backend_stage_id: pulumi.Input[Optional[_builtins.str]] = None,
                 cache_stage_id: pulumi.Input[Optional[_builtins.str]] = None,
                 certificate_expires_at: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def certificate_expires_at(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def certificate_expires_at(self, value: pulumi.Input[Optional[_builtins.str]]):
...
@pulumi.type_token("scaleway:edgeservices/tlsStage:TlsStage")
class TlsStage(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 route_stage_id: pulumi.Input[Optional[_builtins.str]] = None,
                 secrets: pulumi.Input[Optional[Sequence[pulumi.Input[Union['TlsStageSecretArgs', 'TlsStageSecretArgsDict']]]]] = None,
                 waf_stage_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] project_id: `project_id`) The ID of the project the TLS stage is associated with.
        :param pulumi.Input[_builtins.str] route_stage_id: The route stage ID the TLS stage will be linked to. Only one of `backend_stage_id`, `cache_stage_id`, `route_stage_id` and `waf_stage_id` should be specified.
        :param pulumi.Input[Sequence[pulumi.Input[Union['TlsStageSecretArgs', 'TlsStageSecretArgsDict']]]] secrets: The TLS secrets.
        :param pulumi.Input[_builtins.str] waf_stage_id: The WAF stage ID the TLS stage will be linked to. Only one of `backend_stage_id`, `cache_stage_id`, `route_stage_id` and `waf_stage_id` should be specified.
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param TlsStageArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TlsStageArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TlsStageArgs.__new__(TlsStageArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="scaleway:index/edgeServicesTlsStage:EdgeServicesTlsStage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TlsStage, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            secrets: pulumi.Input[Optional[Sequence[pulumi.Input[Union['TlsStageSecretArgs', 'TlsStageSecretArgsDict']]]]] = None,
            updated_at: pulumi.Input[Optional[_builtins.str]] = None,
            waf_stage_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'TlsStage':
        """
        ...
        __props__ = _TlsStageState.__new__(_TlsStageState)
        ...
        __props__.__dict__["waf_stage_id"] = waf_stage_id
        return TlsStage(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def secrets(self) -> pulumi.Output[Sequence['outputs.TlsStageSecret']]:
        """
        The TLS secrets.
        """
        return pulumi.get(self, "secrets")
