...
class GetServerResult:
    ...
    def install_config_afterward(self) -> _builtins.bool:
        return pulumi.get(self, "install_config_afterward")

    @_builtins.property
    @pulumi.getter
    def ips(self) -> Sequence['outputs.GetServerIpResult']:
        return pulumi.get(self, "ips")

    @_builtins.property
    @pulumi.getter
    def ipv4s(self) -> Sequence['outputs.GetServerIpv4Result']:
        return pulumi.get(self, "ipv4s")

    @_builtins.property
    @pulumi.getter
    def ipv6s(self) -> Sequence['outputs.GetServerIpv6Result']:
    ...
    @_builtins.property
    @pulumi.getter
    def partitioning(self) -> _builtins.str:
    ...
    def reinstall_on_config_changes(self) -> _builtins.bool:
    ...
    def service_user(self) -> _builtins.str:
...
def get_server(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str project_id: The ID of the project the baremetal server is associated with.
