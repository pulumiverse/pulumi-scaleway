...
@pulumi.type_token("scaleway:functions/namespace:Namespace")
class Namespace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="scaleway:index/functionNamespace:FunctionNamespace")])
