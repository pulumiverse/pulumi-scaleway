...
__all__ = [
    'GetAuditTrailEventResult',
    'AwaitableGetAuditTrailEventResult',
    'get_audit_trail_event',
    'get_audit_trail_event_output',
]

@pulumi.output_type
class GetAuditTrailEventResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def events(self) -> Sequence['outputs.GetAuditTrailEventEventResult']:
        """
...
class AwaitableGetAuditTrailEventResult(GetAuditTrailEventResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAuditTrailEventResult(
            events=self.events,
            id=self.id,
...
def get_audit_trail_event(method_name: Optional[_builtins.str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAuditTrailEventResult:
    """
    ...
    find_all = scaleway.get_audit_trail_event()
    # Retrieve audit trail events on a specific organization
    find_by_org = scaleway.get_audit_trail_event(organization_id="11111111-1111-1111-1111-111111111111")
    # Retrieve audit trail events on a specific project
    find_by_project = scaleway.get_audit_trail_event(project_id="11111111-1111-1111-1111-111111111111")
    # Retrieve audit trail events for a specific type of resource
    find_by_resource_type = scaleway.get_audit_trail_event(resource_type="instance_server")
    # Retrieve audit trail for a specific resource
    find_by_resource_id = scaleway.get_audit_trail_event(resource_id="11111111-1111-1111-1111-111111111111")
    # Retrieve audit trail for a specific Scaleway product
    find_by_product_name = scaleway.get_audit_trail_event(product_name="secret-manager")
    # Retrieve audit trail events with various filtering
    find_with_filters = scaleway.get_audit_trail_event(region="fr-par",
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:index/getAuditTrailEvent:getAuditTrailEvent', __args__, opts=opts, typ=GetAuditTrailEventResult).value

    return AwaitableGetAuditTrailEventResult(
...
def get_audit_trail_event_output(method_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 ...
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAuditTrailEventResult]:
    """
    Use this data source to get a list of existing Audit Trail events.
    For more information refer to the [Audit Trail API documentation](https://www.scaleway.com/en/developers/api/audit-trail/).
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:index/getAuditTrailEvent:getAuditTrailEvent', __args__, opts=opts, typ=GetAuditTrailEventResult)
    return __ret__.apply(lambda __response__: GetAuditTrailEventResult(
