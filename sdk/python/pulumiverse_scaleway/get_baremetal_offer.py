...
def get_baremetal_offer(include_disabled: Optional[_builtins.bool] = None,
...
def get_baremetal_offer_output(include_disabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
