...
class GetBillingInvoicesResult:
    ...
    def invoice_type(self) -> Optional[_builtins.str]:
        """
        The type of invoice.
        """
...
def get_billing_invoices(invoice_type: Optional[_builtins.str] = None,
...
def get_billing_invoices_output(invoice_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
