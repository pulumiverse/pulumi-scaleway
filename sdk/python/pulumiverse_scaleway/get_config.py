...
class GetConfigResult:
    ...
    def access_key_source(self) -> _builtins.str:
    ...
    def project_id_source(self) -> _builtins.str:
    ...
    def region_source(self) -> _builtins.str:
    ...
    def secret_key_source(self) -> _builtins.str:
    ...
    def zone_source(self) -> _builtins.str:
