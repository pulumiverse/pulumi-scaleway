...
def get_iam_ssh_key(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The SSH key name.
...
def get_iam_ssh_key_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
