...
def get_instance_snapshot(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str project_id: `project_id`) The ID of the project the snapshot is associated with.
    :param _builtins.str snapshot_id: The snapshot id.
           Only one of `name` and `snapshot_id` should be specified.
    :param _builtins.str zone: `zone`) The zone in which the snapshot exists.
    """
...
def get_instance_snapshot_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
