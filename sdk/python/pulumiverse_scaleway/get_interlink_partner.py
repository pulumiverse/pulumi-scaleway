...
__all__ = [
    'GetInterlinkPartnerResult',
    'AwaitableGetInterlinkPartnerResult',
    'get_interlink_partner',
    'get_interlink_partner_output',
]

@pulumi.output_type
class GetInterlinkPartnerResult:
    """
...
class AwaitableGetInterlinkPartnerResult(GetInterlinkPartnerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetInterlinkPartnerResult(
...
def get_interlink_partner(name: Optional[_builtins.str] = None,
                          partner_id: Optional[_builtins.str] = None,
                          region: Optional[_builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetInterlinkPartnerResult:
    """
    ...
    by_id = scaleway.get_interlink_partner(partner_id="fr-par/11111111-1111-1111-1111-111111111111")
    ```
    ...
    by_name = scaleway.get_interlink_partner(name="FreePro")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:index/getInterlinkPartner:getInterlinkPartner', __args__, opts=opts, typ=GetInterlinkPartnerResult).value

    return AwaitableGetInterlinkPartnerResult(
...
def get_interlink_partner_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 partner_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetInterlinkPartnerResult]:
    """
    Gets information about an Interlink Partner.
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:index/getInterlinkPartner:getInterlinkPartner', __args__, opts=opts, typ=GetInterlinkPartnerResult)
    return __ret__.apply(lambda __response__: GetInterlinkPartnerResult(
