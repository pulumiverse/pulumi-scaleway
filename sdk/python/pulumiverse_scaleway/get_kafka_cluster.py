...
class GetKafkaClusterResult:
    ...
    def private_networks(self) -> Sequence['outputs.GetKafkaClusterPrivateNetworkResult']:
        """
    ...
    def public_networks(self) -> Sequence['outputs.GetKafkaClusterPublicNetworkResult']:
        """
...
def get_kafka_cluster(cluster_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:index/getKafkaCluster:getKafkaCluster', __args__, opts=opts, typ=GetKafkaClusterResult).value
...
def get_kafka_cluster_output(cluster_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:index/getKafkaCluster:getKafkaCluster', __args__, opts=opts, typ=GetKafkaClusterResult)
