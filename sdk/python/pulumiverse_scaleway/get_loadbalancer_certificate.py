...
def get_loadbalancer_certificate(certificate_id: Optional[builtins.str] = None,
...
def get_loadbalancer_certificate_output(certificate_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
