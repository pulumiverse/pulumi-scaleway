...
def get_loadbalancer_ip(ip_address: Optional[builtins.str] = None,
...
def get_loadbalancer_ip_output(ip_address: Optional[pulumi.Input[Optional[builtins.str]]] = None,
