...
def get_marketplace_image(image_type: Optional[builtins.str] = None,
    ...
    :param builtins.str image_type: The local image type, `instance_local` or `instance_sbs`.
    :param builtins.str instance_type: The instance type the image is compatible with.
           You find all the available types on the [pricing page](https://www.scaleway.com/en/pricing/).
    :param builtins.str label: Exact label of the desired image. You can use [this endpoint](https://www.scaleway.com/en/developers/api/marketplace/#path-marketplace-images-list-marketplace-images)
...
def get_marketplace_image_output(image_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
