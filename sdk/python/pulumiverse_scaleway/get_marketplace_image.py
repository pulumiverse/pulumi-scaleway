...
def get_marketplace_image(image_type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str image_type: The local image type, `instance_local` or `instance_sbs`.
    :param _builtins.str instance_type: The instance type the image is compatible with.
           You find all the available types on the [pricing page](https://www.scaleway.com/en/pricing/).
    :param _builtins.str label: Exact label of the desired image. You can use [this endpoint](https://www.scaleway.com/en/developers/api/marketplace/#path-marketplace-images-list-marketplace-images)
