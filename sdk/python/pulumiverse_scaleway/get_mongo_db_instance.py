...
def get_mongo_db_instance(instance_id: Optional[builtins.str] = None,
...
def get_mongo_db_instance_output(instance_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
