...
def get_secret_version(organization_id: Optional[_builtins.str] = None,
...
def get_secret_version_output(organization_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
