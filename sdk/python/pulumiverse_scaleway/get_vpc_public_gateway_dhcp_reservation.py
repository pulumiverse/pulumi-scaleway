...
warnings.warn("""scaleway.index/getvpcpublicgatewaydhcpreservation.getVpcPublicGatewayDhcpReservation has been deprecated in favor of scaleway.network/getpublicgatewaydhcpreservation.getPublicGatewayDhcpReservation""", DeprecationWarning)
...
def get_vpc_public_gateway_dhcp_reservation(gateway_network_id: Optional[_builtins.str] = None,
