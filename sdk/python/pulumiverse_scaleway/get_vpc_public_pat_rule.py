...
def get_vpc_public_pat_rule(pat_rule_id: Optional[_builtins.str] = None,
...
def get_vpc_public_pat_rule_output(pat_rule_id: Optional[pulumi.Input[_builtins.str]] = None,
