...
def get_api_key(access_key: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:iam/getApiKey:getApiKey', __args__, opts=opts, typ=GetApiKeyResult).value
...
def get_api_key_output(access_key: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:iam/getApiKey:getApiKey', __args__, opts=opts, typ=GetApiKeyResult)
