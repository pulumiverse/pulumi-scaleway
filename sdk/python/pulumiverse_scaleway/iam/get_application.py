...
class GetApplicationResult:
    ...
    """
    def __init__(__self__, application_id=None, created_at=None, description=None, editable=None, id=None, name=None, organization_id=None, srn=None, tags=None, updated_at=None):
