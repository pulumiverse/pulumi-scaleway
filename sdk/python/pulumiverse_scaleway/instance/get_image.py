...
def get_image_output(architecture: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:instance/getImage:getImage', __args__, opts=opts, typ=GetImageResult)
