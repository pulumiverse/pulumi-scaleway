...
def get_private_nic(private_network_id: Optional[builtins.str] = None,
...
def get_private_nic_output(private_network_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
