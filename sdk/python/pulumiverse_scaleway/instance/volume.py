...
class _VolumeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] migrate_to_sbs: If true, consider that this volume may have been migrated and no longer exists.
        :param pulumi.Input[_builtins.str] name: The name of the volume. If not provided it will be randomly generated.
        :param pulumi.Input[_builtins.str] organization_id: The organization ID the volume is associated with.
        :param pulumi.Input[_builtins.str] project_id: `project_id`) The ID of the project the volume is associated with.
...
@pulumi.type_token("scaleway:instance/volume:Volume")
class Volume(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="fromSnapshotId")
    def from_snapshot_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        If set, the new volume will be created from this snapshot. Only one of `size_in_gb` and `from_snapshot_id` should be specified.
        """
        return pulumi.get(self, "from_snapshot_id")
    ...
    @_builtins.property
    @pulumi.getter(name="migrateToSbs")
    def migrate_to_sbs(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        If true, consider that this volume may have been migrated and no longer exists.
        """
        return pulumi.get(self, "migrate_to_sbs")
