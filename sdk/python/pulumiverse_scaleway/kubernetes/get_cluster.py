...
class GetClusterResult:
    ...
    def admission_plugins(self) -> Sequence[_builtins.str]:
        """
    ...
    def apiserver_cert_sans(self) -> Sequence[_builtins.str]:
        return pulumi.get(self, "apiserver_cert_sans")

    @_builtins.property
    @pulumi.getter(name="apiserverUrl")
    def apiserver_url(self) -> _builtins.str:
        """
    ...
    def feature_gates(self) -> Sequence[_builtins.str]:
        """
    ...
    def upgrade_available(self) -> _builtins.bool:
        """
    ...
    def wildcard_dns(self) -> _builtins.str:
        """
...
def get_cluster(cluster_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The cluster name. Only one of `name` and `cluster_id` should be specified.
    :param _builtins.str project_id: The ID of the project the cluster is associated with.
    :param _builtins.str region: `region`) The region in which the cluster exists.
    """
    __args__ = dict()
...
def get_cluster_output(cluster_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:kubernetes/getCluster:getCluster', __args__, opts=opts, typ=GetClusterResult)
