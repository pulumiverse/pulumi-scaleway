...
class KubernetesNodePoolArgs:
    ...
    def upgrade_policy(self) -> pulumi.Input[Optional['KubernetesNodePoolUpgradePolicyArgs']]:
        """
    ...
    def upgrade_policy(self, value: pulumi.Input[Optional['KubernetesNodePoolUpgradePolicyArgs']]):
