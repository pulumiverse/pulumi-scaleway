...
def get_backends(lb_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str zone: `zone`) The zone in which backends exist.
    """
    __args__ = dict()
    __args__['lbId'] = lb_id
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:loadbalancers/getBackends:getBackends', __args__, opts=opts, typ=GetBackendsResult).value
...
def get_backends_output(lb_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:loadbalancers/getBackends:getBackends', __args__, opts=opts, typ=GetBackendsResult)
