...
def get_certificate(certificate_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str lb_id: The Load Balancer ID this certificate is attached to.
    :param _builtins.str name: The name of the Load Balancer certificate.
...
def get_certificate_output(certificate_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
