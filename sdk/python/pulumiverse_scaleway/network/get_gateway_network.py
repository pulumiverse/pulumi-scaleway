...
def get_gateway_network(dhcp_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:network/getGatewayNetwork:getGatewayNetwork', __args__, opts=opts, typ=GetGatewayNetworkResult).value
...
def get_gateway_network_output(dhcp_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               ...
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGatewayNetworkResult]:
    """
    Gets information about a GatewayNetwork (a connection between a Public Gateway and a Private Network).
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:network/getGatewayNetwork:getGatewayNetwork', __args__, opts=opts, typ=GetGatewayNetworkResult)
    return __ret__.apply(lambda __response__: GetGatewayNetworkResult(
