...
def get_public_gateway(name: Optional[_builtins.str] = None,
...
def get_public_gateway_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              project_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              public_gateway_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              zone: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPublicGatewayResult]:
    """
    Gets information about a Public Gateway.
