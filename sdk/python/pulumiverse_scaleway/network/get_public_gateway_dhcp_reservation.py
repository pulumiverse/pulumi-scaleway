...
def get_public_gateway_dhcp_reservation(gateway_network_id: Optional[builtins.str] = None,
...
def get_public_gateway_dhcp_reservation_output(gateway_network_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
