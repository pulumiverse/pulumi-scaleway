...
def get_public_gateway_pat_rule(pat_rule_id: Optional[builtins.str] = None,
...
def get_public_gateway_pat_rule_output(pat_rule_id: Optional[pulumi.Input[builtins.str]] = None,
