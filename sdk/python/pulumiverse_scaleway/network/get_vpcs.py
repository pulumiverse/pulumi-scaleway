...
def get_vpcs(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:network/getVpcs:getVpcs', __args__, opts=opts, typ=GetVpcsResult).value
...
def get_vpcs_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:network/getVpcs:getVpcs', __args__, opts=opts, typ=GetVpcsResult)
