...
__all__ = ['AlertManagerArgs', 'AlertManager']

@pulumi.input_type
class AlertManagerArgs:
    def __init__(__self__, *,
                 contact_points: pulumi.Input[Optional[Sequence[pulumi.Input['AlertManagerContactPointArgs']]]] = None,
                 enable_managed_alerts: pulumi.Input[Optional[_builtins.bool]] = None,
                 preconfigured_alert_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a AlertManager resource.

        :param pulumi.Input[Sequence[pulumi.Input['AlertManagerContactPointArgs']]] contact_points: A list of contact points with email addresses that will receive alerts. Each map should contain a single key `email`.
    ...
    def contact_points(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AlertManagerContactPointArgs']]]]:
        """
    ...
    def contact_points(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AlertManagerContactPointArgs']]]]):
    ...
    def enable_managed_alerts(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def enable_managed_alerts(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_managed_alerts", value)

    @_builtins.property
    @pulumi.getter(name="preconfiguredAlertIds")
    def preconfigured_alert_ids(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def preconfigured_alert_ids(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
...
class _AlertManagerState:
    def __init__(__self__, *,
                 alert_manager_url: pulumi.Input[Optional[_builtins.str]] = None,
                 contact_points: pulumi.Input[Optional[Sequence[pulumi.Input['AlertManagerContactPointArgs']]]] = None,
                 enable_managed_alerts: pulumi.Input[Optional[_builtins.bool]] = None,
                 preconfigured_alert_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def alert_manager_url(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def alert_manager_url(self, value: pulumi.Input[Optional[_builtins.str]]):
...
@pulumi.type_token("scaleway:observability/alertManager:AlertManager")
class AlertManager(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 contact_points: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AlertManagerContactPointArgs', 'AlertManagerContactPointArgsDict']]]]] = None,
                 enable_managed_alerts: pulumi.Input[Optional[_builtins.bool]] = None,
                 preconfigured_alert_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['AlertManagerContactPointArgs', 'AlertManagerContactPointArgsDict']]]] contact_points: A list of contact points with email addresses that will receive alerts. Each map should contain a single key `email`.
        :param pulumi.Input[_builtins.bool] enable_managed_alerts: **Deprecated** (Optional, Boolean) Use `preconfigured_alert_ids` instead. This field will be removed in a future version. When set to `true`, it enables *all* preconfigured alerts for the project. You cannot filter or disable individual alerts with this legacy flag.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] preconfigured_alert_ids: A set of preconfigured alert rule IDs to enable explicitly. Use the `observability_get_preconfigured_alert` data source to list available alerts.
        :param pulumi.Input[_builtins.str] project_id: ) The ID of the Project the Cockpit is associated with.
        :param pulumi.Input[_builtins.str] region: ) The region where the [alert manager](https://www.scaleway.com/en/docs/observability/cockpit/concepts/#alert-manager) should be enabled.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param AlertManagerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AlertManagerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AlertManagerArgs.__new__(AlertManagerArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="scaleway:index/cockpitAlertManager:CockpitAlertManager")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AlertManager, __self__).__init__(
            'scaleway:observability/alertManager:AlertManager',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            preconfigured_alert_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            project_id: pulumi.Input[Optional[_builtins.str]] = None,
            region: pulumi.Input[Optional[_builtins.str]] = None) -> 'AlertManager':
        """
        ...
        __props__ = _AlertManagerState.__new__(_AlertManagerState)
    ...
    @_builtins.property
    @pulumi.getter(name="contactPoints")
    def contact_points(self) -> pulumi.Output[Optional[Sequence['outputs.AlertManagerContactPoint']]]:
        """
        A list of contact points with email addresses that will receive alerts. Each map should contain a single key `email`.
        """
        return pulumi.get(self, "contact_points")
