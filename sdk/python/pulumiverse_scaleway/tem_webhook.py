...
class _TemWebhookState:
    def __init__(__self__, *,
                 ...
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 sns_arn: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="snsArn")
    def sns_arn(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the SNS topic.
        """
        return pulumi.get(self, "sns_arn")
    ...
    @sns_arn.setter
    def sns_arn(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "sns_arn", value)
...
class TemWebhook(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: pulumi.Input[Optional[_builtins.str]] = None,
            sns_arn: pulumi.Input[Optional[_builtins.str]] = None,
            updated_at: pulumi.Input[Optional[_builtins.str]] = None) -> 'TemWebhook':
        """
